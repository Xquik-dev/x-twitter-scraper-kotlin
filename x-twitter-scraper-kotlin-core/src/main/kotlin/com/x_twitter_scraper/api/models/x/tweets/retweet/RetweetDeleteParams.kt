...
private constructor(
    ...
    /** A builder for [RetweetDeleteParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(retweetDeleteParams: RetweetDeleteParams) = apply {
            id = retweetDeleteParams.id
            idempotencyKey = retweetDeleteParams.idempotencyKey
            body = retweetDeleteParams.body.toBuilder()
            additionalHeaders = retweetDeleteParams.additionalHeaders.toBuilder()
            additionalQueryParams = retweetDeleteParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [RetweetDeleteParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RetweetDeleteParams &&
            id == other.id &&
    ...
    override fun toString() =
        "RetweetDeleteParams{id=$id, idempotencyKey=$idempotencyKey, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
