...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [KeywordCreateResponse].
         *
    ...
    /** A builder for [KeywordCreateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(keywordCreateResponse: KeywordCreateResponse) = apply {
            id = keywordCreateResponse.id
            createdAt = keywordCreateResponse.createdAt
            eventTypes = keywordCreateResponse.eventTypes.map { it.toMutableList() }
            isActive = keywordCreateResponse.isActive
            nextBillingAt = keywordCreateResponse.nextBillingAt
            query = keywordCreateResponse.query
            additionalProperties = keywordCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [KeywordCreateResponse].
         *
         ...
         */
        fun build(): KeywordCreateResponse =
     ...
     *   its expected type.
     */
    fun validate(): KeywordCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is KeywordCreateResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "KeywordCreateResponse{id=$id, createdAt=$createdAt, eventTypes=$eventTypes, isActive=$isActive, nextBillingAt=$nextBillingAt, query=$query, additionalProperties=$additionalProperties}"
}
