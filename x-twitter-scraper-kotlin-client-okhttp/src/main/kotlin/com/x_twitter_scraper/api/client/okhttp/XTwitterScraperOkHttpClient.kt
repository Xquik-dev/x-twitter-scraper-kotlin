...
/**
 * A class that allows building an instance of [XTwitterScraperClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class XTwitterScraperOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [XTwitterScraperClient]. */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): XTwitterScraperClient = builder().fromEnv().build()
    }

    /** A builder for [XTwitterScraperOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [XTwitterScraperClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): XTwitterScraperClient =
