...
internal class ExtractionRunParamsTest {
    ...
    fun queryParams() {
        ...
        assertThat(queryParams).isEqualTo(QueryParams.builder().put("dry_run", "true").build())
    }
    ...
    fun body() {
        ...
        assertThat(body.collectionStrategy()).isEqualTo(ExtractionRunParams.CollectionStrategy.AUTO)
        assertThat(body.conversationId()).isEqualTo("1234567890")
        assertThat(body.dedupeAcrossTargets()).isEqualTo(true)
        assertThat(body.dedupeMode()).isEqualTo(ExtractionRunParams.DedupeMode.NONE)
        ...
        assertThat(body.queryType()).isEqualTo(ExtractionRunParams.QueryType.LATEST)
        ...
        assertThat(body.scope()).isEqualTo(ExtractionRunParams.Scope.ALL)
        ...
        assertThat(body.sinceTime())
            .isEqualTo(
                ExtractionRunParams.SinceTime.ofOffsetDate(
                    OffsetDateTime.parse("2019-12-27T18:11:19.117Z")
                )
            )
        assertThat(body.sort()).isEqualTo(ExtractionRunParams.Sort.RELEVANCE)
        ...
        assertThat(body.targets()).containsExactly(ExtractionRunParams.Target.ofString("string"))
        ...
        assertThat(body.untilTime())
            .isEqualTo(
                ExtractionRunParams.UntilTime.ofOffsetDate(
                    OffsetDateTime.parse("2019-12-27T18:11:19.117Z")
                )
            )
