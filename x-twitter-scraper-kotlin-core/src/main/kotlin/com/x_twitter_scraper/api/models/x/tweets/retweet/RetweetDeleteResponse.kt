...
private constructor(
    ...
    /** A builder for [RetweetDeleteResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(retweetDeleteResponse: RetweetDeleteResponse) = apply {
            id = retweetDeleteResponse.id
            account = retweetDeleteResponse.account
            action = retweetDeleteResponse.action
            billing = retweetDeleteResponse.billing
            charged = retweetDeleteResponse.charged
            chargedCredits = retweetDeleteResponse.chargedCredits
            nextAction = retweetDeleteResponse.nextAction
            object_ = retweetDeleteResponse.object_
            pollAfterMs = retweetDeleteResponse.pollAfterMs
            request = retweetDeleteResponse.request
            result = retweetDeleteResponse.result
            retryable = retweetDeleteResponse.retryable
            safeToRetry = retweetDeleteResponse.safeToRetry
            sendDispatched = retweetDeleteResponse.sendDispatched
            status = retweetDeleteResponse.status
            statusUrl = retweetDeleteResponse.statusUrl
            success = retweetDeleteResponse.success
            target = retweetDeleteResponse.target
            targetId = retweetDeleteResponse.targetId
            terminal = retweetDeleteResponse.terminal
            writeActionId = retweetDeleteResponse.writeActionId
            communityId = retweetDeleteResponse.communityId
            communityName = retweetDeleteResponse.communityName
            completedAt = retweetDeleteResponse.completedAt
            confirmationAttempts = retweetDeleteResponse.confirmationAttempts
            confirmationCheckedAt = retweetDeleteResponse.confirmationCheckedAt
            confirmedAt = retweetDeleteResponse.confirmedAt
            createdAt = retweetDeleteResponse.createdAt
            details = retweetDeleteResponse.details
            error = retweetDeleteResponse.error
            expiresAt = retweetDeleteResponse.expiresAt
            idempotent = retweetDeleteResponse.idempotent
            media = retweetDeleteResponse.media
            mediaId = retweetDeleteResponse.mediaId
            mediaUrl = retweetDeleteResponse.mediaUrl
            message = retweetDeleteResponse.message
            messageId = retweetDeleteResponse.messageId
            requestHash = retweetDeleteResponse.requestHash
            requestId = retweetDeleteResponse.requestId
            resultId = retweetDeleteResponse.resultId
            sendDispatchedAt = retweetDeleteResponse.sendDispatchedAt
            tweetId = retweetDeleteResponse.tweetId
            updatedAt = retweetDeleteResponse.updatedAt
            additionalProperties = retweetDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RetweetDeleteResponse].
         *
         ...
         */
        fun build(): RetweetDeleteResponse =
     ...
     *   its expected type.
     */
    fun validate(): RetweetDeleteResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RetweetDeleteResponse &&
            id == other.id &&
