 ...
 */
@JsonDeserialize(using = UserRetrieveFollowersResponse.Deserializer::class)
@JsonSerialize(using = UserRetrieveFollowersResponse.Serializer::class)
class UserRetrieveFollowersResponse
private constructor(
     ...
     * import com.x_twitter_scraper.api.core.JsonValue
     *
     * val result: String? = userRetrieveFollowersResponse.accept(object : UserRetrieveFollowersResponse.Visitor<String?> {
     ...
     *   its expected type.
     */
    fun validate(): UserRetrieveFollowersResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserRetrieveFollowersResponse &&
    ...
    override fun toString(): String =
        when {
            paginatedUsers != null ->
                "UserRetrieveFollowersResponse{paginatedUsers=$paginatedUsers}"
            listCoverage != null -> "UserRetrieveFollowersResponse{listCoverage=$listCoverage}"
            _json != null -> "UserRetrieveFollowersResponse{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid UserRetrieveFollowersResponse")
        }
    ...
    companion object {
        ...
        fun ofListCoverage(listCoverage: UserListCoverageResponse) =
            UserRetrieveFollowersResponse(listCoverage = listCoverage)
    }

    /**
     * An interface that defines how to map each variant of [UserRetrieveFollowersResponse] to a
     * value of type [T].
     */
    interface Visitor<out T> {
        ...
        /**
         * Maps an unknown variant of [UserRetrieveFollowersResponse] to a value of type [T].
         *
         * An instance of [UserRetrieveFollowersResponse] can contain an unknown variant if it was
        ...
        fun unknown(json: JsonValue?): T {
            throw XTwitterScraperInvalidDataException(
                "Unknown UserRetrieveFollowersResponse: $json"
            )
        }
    }

    internal class Deserializer :
        BaseDeserializer<UserRetrieveFollowersResponse>(UserRetrieveFollowersResponse::class) {

        override fun ObjectCodec.deserialize(node: JsonNode): UserRetrieveFollowersResponse {
            val json = JsonValue.fromJsonNode(node)

            val bestMatches =
                sequenceOf(
                        tryDeserialize(node, jacksonTypeRef<PaginatedUsers>())?.let {
                            UserRetrieveFollowersResponse(paginatedUsers = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<UserListCoverageResponse>())?.let {
                            UserRetrieveFollowersResponse(listCoverage = it, _json = json)
                        },
                    )
                    .filterNotNull()
            ...
            return when (bestMatches.size) {
                ...
                0 -> UserRetrieveFollowersResponse(_json = json)
    ...
    internal class Serializer :
        BaseSerializer<UserRetrieveFollowersResponse>(UserRetrieveFollowersResponse::class) {

        override fun serialize(
            value: UserRetrieveFollowersResponse,
