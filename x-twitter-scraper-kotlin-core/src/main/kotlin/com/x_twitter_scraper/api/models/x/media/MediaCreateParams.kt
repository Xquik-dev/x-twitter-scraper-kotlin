...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MediaCreateParams].
         *
    ...
    /** A builder for [MediaCreateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(mediaCreateParams: MediaCreateParams) = apply {
            body = mediaCreateParams.body.toBuilder()
            additionalHeaders = mediaCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = mediaCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [MediaCreateParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MediaCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "MediaCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
