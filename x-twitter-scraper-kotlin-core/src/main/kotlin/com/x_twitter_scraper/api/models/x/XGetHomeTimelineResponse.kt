...
class XGetHomeTimelineResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [XGetHomeTimelineResponse].
         *
    ...
    /** A builder for [XGetHomeTimelineResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(xGetHomeTimelineResponse: XGetHomeTimelineResponse) = apply {
            hasNextPage = xGetHomeTimelineResponse.hasNextPage
            nextCursor = xGetHomeTimelineResponse.nextCursor
            tweets = xGetHomeTimelineResponse.tweets.map { it.toMutableList() }
            additionalProperties = xGetHomeTimelineResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [XGetHomeTimelineResponse].
         *
         ...
         */
        fun build(): XGetHomeTimelineResponse =
    ...
    fun validate(): XGetHomeTimelineResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is XGetHomeTimelineResponse &&
    ...
    override fun toString() =
        "XGetHomeTimelineResponse{hasNextPage=$hasNextPage, nextCursor=$nextCursor, tweets=$tweets, additionalProperties=$additionalProperties}"
}
