...
class UserRetrieveSearchResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UserRetrieveSearchResponse].
         *
    ...
    /** A builder for [UserRetrieveSearchResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(userRetrieveSearchResponse: UserRetrieveSearchResponse) = apply {
            hasNextPage = userRetrieveSearchResponse.hasNextPage
            nextCursor = userRetrieveSearchResponse.nextCursor
            users = userRetrieveSearchResponse.users.map { it.toMutableList() }
            additionalProperties = userRetrieveSearchResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UserRetrieveSearchResponse].
         *
         ...
         */
        fun build(): UserRetrieveSearchResponse =
    ...
    fun validate(): UserRetrieveSearchResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserRetrieveSearchResponse &&
    ...
    override fun toString() =
        "UserRetrieveSearchResponse{hasNextPage=$hasNextPage, nextCursor=$nextCursor, users=$users, additionalProperties=$additionalProperties}"
}
