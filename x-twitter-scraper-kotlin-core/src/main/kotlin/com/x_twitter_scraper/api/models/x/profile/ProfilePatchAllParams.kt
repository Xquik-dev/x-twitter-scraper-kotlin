...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ProfilePatchAllParams].
         *
    ...
    /** A builder for [ProfilePatchAllParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(profilePatchAllParams: ProfilePatchAllParams) = apply {
            body = profilePatchAllParams.body.toBuilder()
            additionalHeaders = profilePatchAllParams.additionalHeaders.toBuilder()
            additionalQueryParams = profilePatchAllParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ProfilePatchAllParams].
         *
         ...
         */
        fun build(): ProfilePatchAllParams =
    ...
    private constructor(
        ...
        private val hashCode: Int by lazy {
            Objects.hash(account, description, location, name, url, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{account=$account, description=$description, location=$location, name=$name, url=$url, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProfilePatchAllParams &&
            body == other.body &&
    ...
    override fun toString() =
        "ProfilePatchAllParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
