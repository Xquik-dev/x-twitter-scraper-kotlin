...
private constructor(
    ...
    companion object {
        ...
        fun none(): UserRetrieveFollowersYouKnowParams = builder().build()
    ...
    /** A builder for [UserRetrieveFollowersYouKnowParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(userRetrieveFollowersYouKnowParams: UserRetrieveFollowersYouKnowParams) =
            apply {
                id = userRetrieveFollowersYouKnowParams.id
                bioContains = userRetrieveFollowersYouKnowParams.bioContains
                cursor = userRetrieveFollowersYouKnowParams.cursor
                hasLocation = userRetrieveFollowersYouKnowParams.hasLocation
                hasWebsite = userRetrieveFollowersYouKnowParams.hasWebsite
                locationContains = userRetrieveFollowersYouKnowParams.locationContains
                maxFollowers = userRetrieveFollowersYouKnowParams.maxFollowers
                maxFollowing = userRetrieveFollowersYouKnowParams.maxFollowing
                maxStatuses = userRetrieveFollowersYouKnowParams.maxStatuses
                minAccountAgeDays = userRetrieveFollowersYouKnowParams.minAccountAgeDays
                minFollowers = userRetrieveFollowersYouKnowParams.minFollowers
                minFollowing = userRetrieveFollowersYouKnowParams.minFollowing
                minStatuses = userRetrieveFollowersYouKnowParams.minStatuses
                pageSize = userRetrieveFollowersYouKnowParams.pageSize
                usernameContains = userRetrieveFollowersYouKnowParams.usernameContains
                verifiedOnly = userRetrieveFollowersYouKnowParams.verifiedOnly
                verifiedType = userRetrieveFollowersYouKnowParams.verifiedType
        ...
        /**
         * Returns an immutable instance of [UserRetrieveFollowersYouKnowParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UserRetrieveFollowersYouKnowParams =
            UserRetrieveFollowersYouKnowParams(
                id,
                bioContains,
                cursor,
    ...
    override fun toString() =
        "UserRetrieveFollowersYouKnowParams{id=$id, bioContains=$bioContains, cursor=$cursor, hasLocation=$hasLocation, hasWebsite=$hasWebsite, locationContains=$locationContains, maxFollowers=$maxFollowers, maxFollowing=$maxFollowing, maxStatuses=$maxStatuses, minAccountAgeDays=$minAccountAgeDays, minFollowers=$minFollowers, minFollowing=$minFollowing, minStatuses=$minStatuses, pageSize=$pageSize, usernameContains=$usernameContains, verifiedOnly=$verifiedOnly, verifiedType=$verifiedType, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
