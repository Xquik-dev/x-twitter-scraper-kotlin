...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(dmSendResponse: DmSendResponse) = apply {
            id = dmSendResponse.id
            account = dmSendResponse.account
            action = dmSendResponse.action
            billing = dmSendResponse.billing
            charged = dmSendResponse.charged
            chargedCredits = dmSendResponse.chargedCredits
            nextAction = dmSendResponse.nextAction
            object_ = dmSendResponse.object_
            pollAfterMs = dmSendResponse.pollAfterMs
            request = dmSendResponse.request
            result = dmSendResponse.result
            retryable = dmSendResponse.retryable
            safeToRetry = dmSendResponse.safeToRetry
            sendDispatched = dmSendResponse.sendDispatched
            status = dmSendResponse.status
            statusUrl = dmSendResponse.statusUrl
            success = dmSendResponse.success
            target = dmSendResponse.target
            targetId = dmSendResponse.targetId
            terminal = dmSendResponse.terminal
            writeActionId = dmSendResponse.writeActionId
            communityId = dmSendResponse.communityId
            communityName = dmSendResponse.communityName
            completedAt = dmSendResponse.completedAt
            confirmationAttempts = dmSendResponse.confirmationAttempts
            confirmationCheckedAt = dmSendResponse.confirmationCheckedAt
            confirmedAt = dmSendResponse.confirmedAt
            createdAt = dmSendResponse.createdAt
            details = dmSendResponse.details
            error = dmSendResponse.error
            expiresAt = dmSendResponse.expiresAt
            idempotent = dmSendResponse.idempotent
            media = dmSendResponse.media
            mediaId = dmSendResponse.mediaId
            mediaUrl = dmSendResponse.mediaUrl
            message = dmSendResponse.message
            messageId = dmSendResponse.messageId
            requestHash = dmSendResponse.requestHash
            requestId = dmSendResponse.requestId
            resultId = dmSendResponse.resultId
            sendDispatchedAt = dmSendResponse.sendDispatchedAt
            tweetId = dmSendResponse.tweetId
            updatedAt = dmSendResponse.updatedAt
