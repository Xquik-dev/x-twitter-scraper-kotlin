...
private constructor(
    ...
    /** A builder for [StyleRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(styleRetrieveResponse: StyleRetrieveResponse) = apply {
            fetchedAt = styleRetrieveResponse.fetchedAt
            isOwnAccount = styleRetrieveResponse.isOwnAccount
            tweetCount = styleRetrieveResponse.tweetCount
            tweets = styleRetrieveResponse.tweets.map { it.toMutableList() }
            xUsername = styleRetrieveResponse.xUsername
            additionalProperties = styleRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [StyleRetrieveResponse].
         *
         ...
         */
        fun build(): StyleRetrieveResponse =
    ...
    fun validate(): StyleRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StyleRetrieveResponse &&
    ...
    override fun toString() =
        "StyleRetrieveResponse{fetchedAt=$fetchedAt, isOwnAccount=$isOwnAccount, tweetCount=$tweetCount, tweets=$tweets, xUsername=$xUsername, additionalProperties=$additionalProperties}"
}
