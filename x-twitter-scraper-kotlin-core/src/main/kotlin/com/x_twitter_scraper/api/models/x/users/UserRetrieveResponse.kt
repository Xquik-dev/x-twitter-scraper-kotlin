...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(userRetrieveResponse: UserRetrieveResponse) = apply {
            ...
            description = userRetrieveResponse.description
            followers = userRetrieveResponse.followers
            following = userRetrieveResponse.following
            location = userRetrieveResponse.location
            profilePicture = userRetrieveResponse.profilePicture
            statusesCount = userRetrieveResponse.statusesCount
            verified = userRetrieveResponse.verified
    ...
    override fun toString() =
        "UserRetrieveResponse{id=$id, name=$name, username=$username, createdAt=$createdAt, description=$description, followers=$followers, following=$following, location=$location, profilePicture=$profilePicture, statusesCount=$statusesCount, verified=$verified, additionalProperties=$additionalProperties}"
}
