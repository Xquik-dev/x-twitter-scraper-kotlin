...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(followDeleteAllParams: FollowDeleteAllParams) = apply {
            ...
            idempotencyKey = followDeleteAllParams.idempotencyKey
        ...
        /**
         * Returns an immutable instance of [FollowDeleteAllParams].
         *
    ...
    override fun toString() =
        "FollowDeleteAllParams{id=$id, idempotencyKey=$idempotencyKey, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
