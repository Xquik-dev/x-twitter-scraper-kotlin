...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TicketUpdateParams].
         *
    ...
    /** A builder for [TicketUpdateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(ticketUpdateParams: TicketUpdateParams) = apply {
            id = ticketUpdateParams.id
            body = ticketUpdateParams.body.toBuilder()
            additionalHeaders = ticketUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = ticketUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TicketUpdateParams].
         *
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(checkRequired("status", status), additionalProperties.toMutableMap())
        }
    ...
    override fun toString() =
        "TicketUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
