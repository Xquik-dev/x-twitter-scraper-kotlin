...
class TweetGetRetweetersResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TweetGetRetweetersResponse].
         *
    ...
    /** A builder for [TweetGetRetweetersResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(tweetGetRetweetersResponse: TweetGetRetweetersResponse) = apply {
            hasNextPage = tweetGetRetweetersResponse.hasNextPage
            nextCursor = tweetGetRetweetersResponse.nextCursor
            users = tweetGetRetweetersResponse.users.map { it.toMutableList() }
            additionalProperties = tweetGetRetweetersResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TweetGetRetweetersResponse].
         *
         ...
         */
        fun build(): TweetGetRetweetersResponse =
    ...
    fun validate(): TweetGetRetweetersResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TweetGetRetweetersResponse &&
    ...
    override fun toString() =
        "TweetGetRetweetersResponse{hasNextPage=$hasNextPage, nextCursor=$nextCursor, users=$users, additionalProperties=$additionalProperties}"
}
