 ...
 * a new key.
 */
class UserRemoveFollowerResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UserRemoveFollowerResponse].
         *
    ...
    /** A builder for [UserRemoveFollowerResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(userRemoveFollowerResponse: UserRemoveFollowerResponse) = apply {
            id = userRemoveFollowerResponse.id
            account = userRemoveFollowerResponse.account
            action = userRemoveFollowerResponse.action
            billing = userRemoveFollowerResponse.billing
            charged = userRemoveFollowerResponse.charged
            chargedCredits = userRemoveFollowerResponse.chargedCredits
            nextAction = userRemoveFollowerResponse.nextAction
            object_ = userRemoveFollowerResponse.object_
            pollAfterMs = userRemoveFollowerResponse.pollAfterMs
            request = userRemoveFollowerResponse.request
            result = userRemoveFollowerResponse.result
            retryable = userRemoveFollowerResponse.retryable
            safeToRetry = userRemoveFollowerResponse.safeToRetry
            sendDispatched = userRemoveFollowerResponse.sendDispatched
            status = userRemoveFollowerResponse.status
            statusUrl = userRemoveFollowerResponse.statusUrl
            success = userRemoveFollowerResponse.success
            target = userRemoveFollowerResponse.target
            targetId = userRemoveFollowerResponse.targetId
            terminal = userRemoveFollowerResponse.terminal
            writeActionId = userRemoveFollowerResponse.writeActionId
            communityId = userRemoveFollowerResponse.communityId
            communityName = userRemoveFollowerResponse.communityName
            completedAt = userRemoveFollowerResponse.completedAt
            confirmationAttempts = userRemoveFollowerResponse.confirmationAttempts
            confirmationCheckedAt = userRemoveFollowerResponse.confirmationCheckedAt
            confirmedAt = userRemoveFollowerResponse.confirmedAt
            createdAt = userRemoveFollowerResponse.createdAt
            details = userRemoveFollowerResponse.details
            error = userRemoveFollowerResponse.error
            expiresAt = userRemoveFollowerResponse.expiresAt
            idempotent = userRemoveFollowerResponse.idempotent
            media = userRemoveFollowerResponse.media
            mediaId = userRemoveFollowerResponse.mediaId
            mediaUrl = userRemoveFollowerResponse.mediaUrl
            message = userRemoveFollowerResponse.message
            messageId = userRemoveFollowerResponse.messageId
            requestHash = userRemoveFollowerResponse.requestHash
            requestId = userRemoveFollowerResponse.requestId
            resultId = userRemoveFollowerResponse.resultId
            sendDispatchedAt = userRemoveFollowerResponse.sendDispatchedAt
            tweetId = userRemoveFollowerResponse.tweetId
            updatedAt = userRemoveFollowerResponse.updatedAt
            additionalProperties = userRemoveFollowerResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UserRemoveFollowerResponse].
         *
         ...
         */
        fun build(): UserRemoveFollowerResponse =
     ...
     *   its expected type.
     */
    fun validate(): UserRemoveFollowerResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserRemoveFollowerResponse &&
            id == other.id &&
