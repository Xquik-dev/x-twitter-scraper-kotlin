...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LikeDeleteResponse].
         *
    ...
    /** A builder for [LikeDeleteResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(likeDeleteResponse: LikeDeleteResponse) = apply {
            id = likeDeleteResponse.id
            account = likeDeleteResponse.account
            action = likeDeleteResponse.action
            billing = likeDeleteResponse.billing
            charged = likeDeleteResponse.charged
            chargedCredits = likeDeleteResponse.chargedCredits
            nextAction = likeDeleteResponse.nextAction
            object_ = likeDeleteResponse.object_
            pollAfterMs = likeDeleteResponse.pollAfterMs
            request = likeDeleteResponse.request
            result = likeDeleteResponse.result
            retryable = likeDeleteResponse.retryable
            safeToRetry = likeDeleteResponse.safeToRetry
            sendDispatched = likeDeleteResponse.sendDispatched
            status = likeDeleteResponse.status
            statusUrl = likeDeleteResponse.statusUrl
            success = likeDeleteResponse.success
            target = likeDeleteResponse.target
            targetId = likeDeleteResponse.targetId
            terminal = likeDeleteResponse.terminal
            writeActionId = likeDeleteResponse.writeActionId
            communityId = likeDeleteResponse.communityId
            communityName = likeDeleteResponse.communityName
            completedAt = likeDeleteResponse.completedAt
            confirmationAttempts = likeDeleteResponse.confirmationAttempts
            confirmationCheckedAt = likeDeleteResponse.confirmationCheckedAt
            confirmedAt = likeDeleteResponse.confirmedAt
            createdAt = likeDeleteResponse.createdAt
            details = likeDeleteResponse.details
            error = likeDeleteResponse.error
            expiresAt = likeDeleteResponse.expiresAt
            idempotent = likeDeleteResponse.idempotent
            media = likeDeleteResponse.media
            mediaId = likeDeleteResponse.mediaId
            mediaUrl = likeDeleteResponse.mediaUrl
            message = likeDeleteResponse.message
            messageId = likeDeleteResponse.messageId
            requestHash = likeDeleteResponse.requestHash
            requestId = likeDeleteResponse.requestId
            resultId = likeDeleteResponse.resultId
            sendDispatchedAt = likeDeleteResponse.sendDispatchedAt
            tweetId = likeDeleteResponse.tweetId
            updatedAt = likeDeleteResponse.updatedAt
            additionalProperties = likeDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LikeDeleteResponse].
         *
     ...
     *   its expected type.
     */
    fun validate(): LikeDeleteResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LikeDeleteResponse &&
            id == other.id &&
