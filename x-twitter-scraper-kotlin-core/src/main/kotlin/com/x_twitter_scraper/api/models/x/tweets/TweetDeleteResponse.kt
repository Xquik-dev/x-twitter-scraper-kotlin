...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TweetDeleteResponse].
         *
    ...
    /** A builder for [TweetDeleteResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(tweetDeleteResponse: TweetDeleteResponse) = apply {
            id = tweetDeleteResponse.id
            account = tweetDeleteResponse.account
            action = tweetDeleteResponse.action
            billing = tweetDeleteResponse.billing
            charged = tweetDeleteResponse.charged
            chargedCredits = tweetDeleteResponse.chargedCredits
            nextAction = tweetDeleteResponse.nextAction
            object_ = tweetDeleteResponse.object_
            pollAfterMs = tweetDeleteResponse.pollAfterMs
            request = tweetDeleteResponse.request
            result = tweetDeleteResponse.result
            retryable = tweetDeleteResponse.retryable
            safeToRetry = tweetDeleteResponse.safeToRetry
            sendDispatched = tweetDeleteResponse.sendDispatched
            status = tweetDeleteResponse.status
            statusUrl = tweetDeleteResponse.statusUrl
            success = tweetDeleteResponse.success
            target = tweetDeleteResponse.target
            targetId = tweetDeleteResponse.targetId
            terminal = tweetDeleteResponse.terminal
            writeActionId = tweetDeleteResponse.writeActionId
            communityId = tweetDeleteResponse.communityId
            communityName = tweetDeleteResponse.communityName
            completedAt = tweetDeleteResponse.completedAt
            confirmationAttempts = tweetDeleteResponse.confirmationAttempts
            confirmationCheckedAt = tweetDeleteResponse.confirmationCheckedAt
            confirmedAt = tweetDeleteResponse.confirmedAt
            createdAt = tweetDeleteResponse.createdAt
            details = tweetDeleteResponse.details
            error = tweetDeleteResponse.error
            expiresAt = tweetDeleteResponse.expiresAt
            idempotent = tweetDeleteResponse.idempotent
            media = tweetDeleteResponse.media
            mediaId = tweetDeleteResponse.mediaId
            mediaUrl = tweetDeleteResponse.mediaUrl
            message = tweetDeleteResponse.message
            messageId = tweetDeleteResponse.messageId
            requestHash = tweetDeleteResponse.requestHash
            requestId = tweetDeleteResponse.requestId
            resultId = tweetDeleteResponse.resultId
            sendDispatchedAt = tweetDeleteResponse.sendDispatchedAt
            tweetId = tweetDeleteResponse.tweetId
            updatedAt = tweetDeleteResponse.updatedAt
            additionalProperties = tweetDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TweetDeleteResponse].
         *
     ...
     *   its expected type.
     */
    fun validate(): TweetDeleteResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TweetDeleteResponse &&
            id == other.id &&
