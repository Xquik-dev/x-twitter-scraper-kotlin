...
private constructor(
    ...
    /** A builder for [UserRetrieveFollowingResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(userRetrieveFollowingResponse: UserRetrieveFollowingResponse) = apply {
            hasNextPage = userRetrieveFollowingResponse.hasNextPage
            nextCursor = userRetrieveFollowingResponse.nextCursor
            users = userRetrieveFollowingResponse.users.map { it.toMutableList() }
            additionalProperties = userRetrieveFollowingResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UserRetrieveFollowingResponse].
         *
         ...
         */
        fun build(): UserRetrieveFollowingResponse =
            UserRetrieveFollowingResponse(
    ...
    override fun toString() =
        "UserRetrieveFollowingResponse{hasNextPage=$hasNextPage, nextCursor=$nextCursor, users=$users, additionalProperties=$additionalProperties}"
}
