...
class UserRetrieveMentionsResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UserRetrieveMentionsResponse].
         *
    ...
    /** A builder for [UserRetrieveMentionsResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(userRetrieveMentionsResponse: UserRetrieveMentionsResponse) = apply {
            hasNextPage = userRetrieveMentionsResponse.hasNextPage
            nextCursor = userRetrieveMentionsResponse.nextCursor
            tweets = userRetrieveMentionsResponse.tweets.map { it.toMutableList() }
            additionalProperties = userRetrieveMentionsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UserRetrieveMentionsResponse].
         *
         ...
         */
        fun build(): UserRetrieveMentionsResponse =
    ...
    fun validate(): UserRetrieveMentionsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserRetrieveMentionsResponse &&
    ...
    override fun toString() =
        "UserRetrieveMentionsResponse{hasNextPage=$hasNextPage, nextCursor=$nextCursor, tweets=$tweets, additionalProperties=$additionalProperties}"
}
