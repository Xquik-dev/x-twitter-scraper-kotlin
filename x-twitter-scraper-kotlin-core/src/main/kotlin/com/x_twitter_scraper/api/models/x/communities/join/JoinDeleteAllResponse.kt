...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [JoinDeleteAllResponse].
         *
    ...
    /** A builder for [JoinDeleteAllResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(joinDeleteAllResponse: JoinDeleteAllResponse) = apply {
            id = joinDeleteAllResponse.id
            account = joinDeleteAllResponse.account
            action = joinDeleteAllResponse.action
            billing = joinDeleteAllResponse.billing
            charged = joinDeleteAllResponse.charged
            chargedCredits = joinDeleteAllResponse.chargedCredits
            nextAction = joinDeleteAllResponse.nextAction
            object_ = joinDeleteAllResponse.object_
            pollAfterMs = joinDeleteAllResponse.pollAfterMs
            request = joinDeleteAllResponse.request
            result = joinDeleteAllResponse.result
            retryable = joinDeleteAllResponse.retryable
            safeToRetry = joinDeleteAllResponse.safeToRetry
            sendDispatched = joinDeleteAllResponse.sendDispatched
            status = joinDeleteAllResponse.status
            statusUrl = joinDeleteAllResponse.statusUrl
            success = joinDeleteAllResponse.success
            target = joinDeleteAllResponse.target
            targetId = joinDeleteAllResponse.targetId
            terminal = joinDeleteAllResponse.terminal
            writeActionId = joinDeleteAllResponse.writeActionId
            communityId = joinDeleteAllResponse.communityId
            communityName = joinDeleteAllResponse.communityName
            completedAt = joinDeleteAllResponse.completedAt
            confirmationAttempts = joinDeleteAllResponse.confirmationAttempts
            confirmationCheckedAt = joinDeleteAllResponse.confirmationCheckedAt
            confirmedAt = joinDeleteAllResponse.confirmedAt
            createdAt = joinDeleteAllResponse.createdAt
            details = joinDeleteAllResponse.details
            error = joinDeleteAllResponse.error
            expiresAt = joinDeleteAllResponse.expiresAt
            idempotent = joinDeleteAllResponse.idempotent
            media = joinDeleteAllResponse.media
            mediaId = joinDeleteAllResponse.mediaId
            mediaUrl = joinDeleteAllResponse.mediaUrl
            message = joinDeleteAllResponse.message
            messageId = joinDeleteAllResponse.messageId
            requestHash = joinDeleteAllResponse.requestHash
            requestId = joinDeleteAllResponse.requestId
            resultId = joinDeleteAllResponse.resultId
            sendDispatchedAt = joinDeleteAllResponse.sendDispatchedAt
            tweetId = joinDeleteAllResponse.tweetId
            updatedAt = joinDeleteAllResponse.updatedAt
            additionalProperties = joinDeleteAllResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [JoinDeleteAllResponse].
         *
         ...
         */
        fun build(): JoinDeleteAllResponse =
     ...
     *   its expected type.
     */
    fun validate(): JoinDeleteAllResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is JoinDeleteAllResponse &&
            id == other.id &&
