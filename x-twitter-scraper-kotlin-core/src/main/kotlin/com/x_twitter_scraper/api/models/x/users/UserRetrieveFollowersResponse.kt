...
private constructor(
    ...
    /** A builder for [UserRetrieveFollowersResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(userRetrieveFollowersResponse: UserRetrieveFollowersResponse) = apply {
            hasNextPage = userRetrieveFollowersResponse.hasNextPage
            nextCursor = userRetrieveFollowersResponse.nextCursor
            users = userRetrieveFollowersResponse.users.map { it.toMutableList() }
            additionalProperties = userRetrieveFollowersResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UserRetrieveFollowersResponse].
         *
         ...
         */
        fun build(): UserRetrieveFollowersResponse =
            UserRetrieveFollowersResponse(
    ...
    override fun toString() =
        "UserRetrieveFollowersResponse{hasNextPage=$hasNextPage, nextCursor=$nextCursor, users=$users, additionalProperties=$additionalProperties}"
}
