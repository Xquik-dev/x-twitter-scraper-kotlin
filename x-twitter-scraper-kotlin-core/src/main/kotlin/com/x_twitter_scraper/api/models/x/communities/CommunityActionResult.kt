...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CommunityActionResult].
         *
    ...
    /** A builder for [CommunityActionResult]. */
    class Builder internal constructor() {
        ...
        internal fun from(communityActionResult: CommunityActionResult) = apply {
            communityId = communityActionResult.communityId
            communityName = communityActionResult.communityName
            success = communityActionResult.success
            additionalProperties = communityActionResult.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CommunityActionResult].
         *
         ...
         */
        fun build(): CommunityActionResult =
    ...
    fun validate(): CommunityActionResult = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CommunityActionResult &&
    ...
    override fun toString() =
        "CommunityActionResult{communityId=$communityId, communityName=$communityName, success=$success, additionalProperties=$additionalProperties}"
}
