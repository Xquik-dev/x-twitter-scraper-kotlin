...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IntegrationCreateResponse].
         *
    ...
    /** A builder for [IntegrationCreateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(integrationCreateResponse: IntegrationCreateResponse) = apply {
            id = integrationCreateResponse.id
            config = integrationCreateResponse.config
            createdAt = integrationCreateResponse.createdAt
            eventTypes = integrationCreateResponse.eventTypes.map { it.toMutableList() }
            isActive = integrationCreateResponse.isActive
            name = integrationCreateResponse.name
            type = integrationCreateResponse.type
            filters = integrationCreateResponse.filters
            messageTemplate = integrationCreateResponse.messageTemplate
            scopeAllMonitors = integrationCreateResponse.scopeAllMonitors
            silentPush = integrationCreateResponse.silentPush
            additionalProperties = integrationCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IntegrationCreateResponse].
         *
         ...
         */
        fun build(): IntegrationCreateResponse =
    ...
    fun validate(): IntegrationCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IntegrationCreateResponse &&
            id == other.id &&
            config == other.config &&
    ...
    override fun toString() =
        "IntegrationCreateResponse{id=$id, config=$config, createdAt=$createdAt, eventTypes=$eventTypes, isActive=$isActive, name=$name, type=$type, filters=$filters, messageTemplate=$messageTemplate, scopeAllMonitors=$scopeAllMonitors, silentPush=$silentPush, additionalProperties=$additionalProperties}"
}
