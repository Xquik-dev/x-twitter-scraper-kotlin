...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CommunityCreateParams].
         *
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [CommunityCreateParams].
         *
    ...
    private constructor(
        ...
        private val hashCode: Int by lazy {
            Objects.hash(account, name, description, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{account=$account, name=$name, description=$description, additionalProperties=$additionalProperties}"
    }
