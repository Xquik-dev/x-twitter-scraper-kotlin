...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TweetGetQuotesResponse].
         *
    ...
    /** A builder for [TweetGetQuotesResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(tweetGetQuotesResponse: TweetGetQuotesResponse) = apply {
            hasNextPage = tweetGetQuotesResponse.hasNextPage
            nextCursor = tweetGetQuotesResponse.nextCursor
            tweets = tweetGetQuotesResponse.tweets.map { it.toMutableList() }
            additionalProperties = tweetGetQuotesResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TweetGetQuotesResponse].
         *
         ...
         */
        fun build(): TweetGetQuotesResponse =
    ...
    fun validate(): TweetGetQuotesResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TweetGetQuotesResponse &&
    ...
    override fun toString() =
        "TweetGetQuotesResponse{hasNextPage=$hasNextPage, nextCursor=$nextCursor, tweets=$tweets, additionalProperties=$additionalProperties}"
}
