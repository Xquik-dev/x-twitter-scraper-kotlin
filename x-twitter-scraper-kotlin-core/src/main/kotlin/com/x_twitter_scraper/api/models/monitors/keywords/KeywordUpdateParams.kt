...
private constructor(
    ...
    companion object {
        ...
        fun none(): KeywordUpdateParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [KeywordUpdateParams]. */
        fun builder() = Builder()
    }

    /** A builder for [KeywordUpdateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(keywordUpdateParams: KeywordUpdateParams) = apply {
            id = keywordUpdateParams.id
            body = keywordUpdateParams.body.toBuilder()
            additionalHeaders = keywordUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = keywordUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [KeywordUpdateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): KeywordUpdateParams =
            KeywordUpdateParams(
                id,
                body.build(),
    ...
    private constructor(
        ...
        private val hashCode: Int by lazy {
            Objects.hash(eventTypes, isActive, additionalProperties)
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is KeywordUpdateParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "KeywordUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
