...
private constructor(
    ...
    private constructor(
        ...
        ) : this(eventTypes, url, mutableMapOf())
        ...
        private val hashCode: Int by lazy { Objects.hash(eventTypes, url, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{eventTypes=$eventTypes, url=$url, additionalProperties=$additionalProperties}"
    }
