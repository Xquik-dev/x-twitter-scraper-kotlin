...
private constructor(
    ...
    companion object {
        ...
        fun none(): WebhookListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        fun build(): WebhookListParams =
            WebhookListParams(additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "WebhookListParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
