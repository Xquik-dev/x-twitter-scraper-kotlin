...
class ListRetrieveTweetsResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ListRetrieveTweetsResponse].
         *
    ...
    /** A builder for [ListRetrieveTweetsResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(listRetrieveTweetsResponse: ListRetrieveTweetsResponse) = apply {
            hasNextPage = listRetrieveTweetsResponse.hasNextPage
            nextCursor = listRetrieveTweetsResponse.nextCursor
            tweets = listRetrieveTweetsResponse.tweets.map { it.toMutableList() }
            additionalProperties = listRetrieveTweetsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ListRetrieveTweetsResponse].
         *
         ...
         */
        fun build(): ListRetrieveTweetsResponse =
    ...
    fun validate(): ListRetrieveTweetsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ListRetrieveTweetsResponse &&
    ...
    override fun toString() =
        "ListRetrieveTweetsResponse{hasNextPage=$hasNextPage, nextCursor=$nextCursor, tweets=$tweets, additionalProperties=$additionalProperties}"
}
