...
internal class IntegrationListDeliveriesParamsTest {
    ...
    @Test
    fun pathParams() {
        val params = IntegrationListDeliveriesParams.builder().id("id").build()
    ...
    @Test
    fun queryParams() {
        val params = IntegrationListDeliveriesParams.builder().id("id").limit(1L).build()
