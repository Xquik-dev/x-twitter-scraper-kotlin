...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SubscribeCreateResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [SubscribeCreateResponse].
         *
     ...
     *   its expected type.
     */
    fun validate(): SubscribeCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    class Status @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val CHECKOUT_CREATED = of("checkout_created")

            val ALREADY_SUBSCRIBED = of("already_subscribed")

            val PAYMENT_ISSUE = of("payment_issue")
        ...
        fun value(): Value =
            when (this) {
                ...
                ALREADY_SUBSCRIBED -> Value.ALREADY_SUBSCRIBED
        ...
        fun known(): Known =
            when (this) {
                CHECKOUT_CREATED -> Known.CHECKOUT_CREATED
                ALREADY_SUBSCRIBED -> Known.ALREADY_SUBSCRIBED
