    ...
    fun create() {
        val userRetrieveBatchResponse =
            UserRetrieveBatchResponse.builder()
                ...
                .addUser(
                    UserRetrieveBatchResponse.User.builder()
                        .id("9876543210")
                        .name("Elon Musk")
                        .username("elonmusk")
        ...
        assertThat(userRetrieveBatchResponse.hasNextPage()).isEqualTo(true)
        assertThat(userRetrieveBatchResponse.nextCursor()).isEqualTo("DAACCgACGRElMJcAAA")
