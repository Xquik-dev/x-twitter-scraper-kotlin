...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UserRetrieveTweetsResponse].
         *
    ...
    /** A builder for [UserRetrieveTweetsResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(userRetrieveTweetsResponse: UserRetrieveTweetsResponse) = apply {
            hasNextPage = userRetrieveTweetsResponse.hasNextPage
            nextCursor = userRetrieveTweetsResponse.nextCursor
            tweets = userRetrieveTweetsResponse.tweets.map { it.toMutableList() }
            additionalProperties = userRetrieveTweetsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UserRetrieveTweetsResponse].
         *
         ...
         */
        fun build(): UserRetrieveTweetsResponse =
    ...
    fun validate(): UserRetrieveTweetsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserRetrieveTweetsResponse &&
    ...
    override fun toString() =
        "UserRetrieveTweetsResponse{hasNextPage=$hasNextPage, nextCursor=$nextCursor, tweets=$tweets, additionalProperties=$additionalProperties}"
}
