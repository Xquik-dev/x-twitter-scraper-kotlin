...
internal class TweetListByCommunityParamsTest {
    ...
    @Test
    fun pathParams() {
        val params = TweetListByCommunityParams.builder().id("id").build()
    ...
    @Test
    fun queryParams() {
        val params = TweetListByCommunityParams.builder().id("id").cursor("cursor").build()
