...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(draftCreateParams: DraftCreateParams) = apply {
            body = draftCreateParams.body.toBuilder()
    ...
    private constructor(
        ...
        ) : this(text, goal, topic, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(checkRequired("text", text), goal, topic, additionalProperties.toMutableMap())
        }
        ...
        private val hashCode: Int by lazy { Objects.hash(text, goal, topic, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{text=$text, goal=$goal, topic=$topic, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "DraftCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
