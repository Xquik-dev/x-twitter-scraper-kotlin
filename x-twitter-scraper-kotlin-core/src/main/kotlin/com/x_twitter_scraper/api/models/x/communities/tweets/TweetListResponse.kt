...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TweetListResponse].
         *
    ...
    /** A builder for [TweetListResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(tweetListResponse: TweetListResponse) = apply {
            hasNextPage = tweetListResponse.hasNextPage
            nextCursor = tweetListResponse.nextCursor
            tweets = tweetListResponse.tweets.map { it.toMutableList() }
            additionalProperties = tweetListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TweetListResponse].
         *
    ...
    fun validate(): TweetListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TweetListResponse &&
    ...
    override fun toString() =
        "TweetListResponse{hasNextPage=$hasNextPage, nextCursor=$nextCursor, tweets=$tweets, additionalProperties=$additionalProperties}"
}
