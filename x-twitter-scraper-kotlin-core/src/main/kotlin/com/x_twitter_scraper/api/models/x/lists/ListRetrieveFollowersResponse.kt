...
class ListRetrieveFollowersResponse
...
private constructor(
    ...
    /** A builder for [ListRetrieveFollowersResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(listRetrieveFollowersResponse: ListRetrieveFollowersResponse) = apply {
            hasNextPage = listRetrieveFollowersResponse.hasNextPage
            nextCursor = listRetrieveFollowersResponse.nextCursor
            users = listRetrieveFollowersResponse.users.map { it.toMutableList() }
            additionalProperties = listRetrieveFollowersResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ListRetrieveFollowersResponse].
         *
         ...
         */
        fun build(): ListRetrieveFollowersResponse =
            ListRetrieveFollowersResponse(
    ...
    fun validate(): ListRetrieveFollowersResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ListRetrieveFollowersResponse &&
    ...
    override fun toString() =
        "ListRetrieveFollowersResponse{hasNextPage=$hasNextPage, nextCursor=$nextCursor, users=$users, additionalProperties=$additionalProperties}"
}
