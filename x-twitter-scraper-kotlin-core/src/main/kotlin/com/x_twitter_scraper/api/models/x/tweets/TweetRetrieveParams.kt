...
private constructor(
    ...
    companion object {
        ...
        fun none(): TweetRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [TweetRetrieveParams]. */
        fun builder() = Builder()
    }
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [TweetRetrieveParams].
         *
