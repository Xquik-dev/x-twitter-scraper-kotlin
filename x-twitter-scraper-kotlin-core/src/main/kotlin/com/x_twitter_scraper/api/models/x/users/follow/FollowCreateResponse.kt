...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FollowCreateResponse].
         *
    ...
    /** A builder for [FollowCreateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(followCreateResponse: FollowCreateResponse) = apply {
            id = followCreateResponse.id
            account = followCreateResponse.account
            action = followCreateResponse.action
            billing = followCreateResponse.billing
            charged = followCreateResponse.charged
            chargedCredits = followCreateResponse.chargedCredits
            nextAction = followCreateResponse.nextAction
            object_ = followCreateResponse.object_
            pollAfterMs = followCreateResponse.pollAfterMs
            request = followCreateResponse.request
            result = followCreateResponse.result
            retryable = followCreateResponse.retryable
            safeToRetry = followCreateResponse.safeToRetry
            sendDispatched = followCreateResponse.sendDispatched
            status = followCreateResponse.status
            statusUrl = followCreateResponse.statusUrl
            success = followCreateResponse.success
            target = followCreateResponse.target
            targetId = followCreateResponse.targetId
            terminal = followCreateResponse.terminal
            writeActionId = followCreateResponse.writeActionId
            communityId = followCreateResponse.communityId
            communityName = followCreateResponse.communityName
            completedAt = followCreateResponse.completedAt
            confirmationAttempts = followCreateResponse.confirmationAttempts
            confirmationCheckedAt = followCreateResponse.confirmationCheckedAt
            confirmedAt = followCreateResponse.confirmedAt
            createdAt = followCreateResponse.createdAt
            details = followCreateResponse.details
            error = followCreateResponse.error
            expiresAt = followCreateResponse.expiresAt
            idempotent = followCreateResponse.idempotent
            media = followCreateResponse.media
            mediaId = followCreateResponse.mediaId
            mediaUrl = followCreateResponse.mediaUrl
            message = followCreateResponse.message
            messageId = followCreateResponse.messageId
            requestHash = followCreateResponse.requestHash
            requestId = followCreateResponse.requestId
            resultId = followCreateResponse.resultId
            sendDispatchedAt = followCreateResponse.sendDispatchedAt
            tweetId = followCreateResponse.tweetId
            updatedAt = followCreateResponse.updatedAt
            additionalProperties = followCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FollowCreateResponse].
         *
         ...
         */
        fun build(): FollowCreateResponse =
     ...
     *   its expected type.
     */
    fun validate(): FollowCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FollowCreateResponse &&
            id == other.id &&
