...
class CommunityRetrieveSearchResponse
...
private constructor(
    ...
    /** A builder for [CommunityRetrieveSearchResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(communityRetrieveSearchResponse: CommunityRetrieveSearchResponse) =
            apply {
                hasNextPage = communityRetrieveSearchResponse.hasNextPage
                nextCursor = communityRetrieveSearchResponse.nextCursor
                tweets = communityRetrieveSearchResponse.tweets.map { it.toMutableList() }
                additionalProperties =
                    communityRetrieveSearchResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CommunityRetrieveSearchResponse].
         *
         ...
         */
        fun build(): CommunityRetrieveSearchResponse =
            CommunityRetrieveSearchResponse(
    ...
    fun validate(): CommunityRetrieveSearchResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CommunityRetrieveSearchResponse &&
    ...
    override fun toString() =
        "CommunityRetrieveSearchResponse{hasNextPage=$hasNextPage, nextCursor=$nextCursor, tweets=$tweets, additionalProperties=$additionalProperties}"
}
