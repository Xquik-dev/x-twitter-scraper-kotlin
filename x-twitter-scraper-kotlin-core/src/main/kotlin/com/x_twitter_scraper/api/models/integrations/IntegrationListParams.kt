...
private constructor(
    ...
    companion object {
        ...
        fun none(): IntegrationListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        fun build(): IntegrationListParams =
            IntegrationListParams(additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "IntegrationListParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
