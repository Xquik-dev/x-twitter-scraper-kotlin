...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [StyleProfile].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(styleProfile: StyleProfile) = apply {
            fetchedAt = styleProfile.fetchedAt
            isOwnAccount = styleProfile.isOwnAccount
            tweetCount = styleProfile.tweetCount
            tweets = styleProfile.tweets.map { it.toMutableList() }
            xUsername = styleProfile.xUsername
            additionalProperties = styleProfile.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [StyleProfile].
         *
     ...
     *   its expected type.
     */
    fun validate(): StyleProfile = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "StyleProfile{fetchedAt=$fetchedAt, isOwnAccount=$isOwnAccount, tweetCount=$tweetCount, tweets=$tweets, xUsername=$xUsername, additionalProperties=$additionalProperties}"
}
