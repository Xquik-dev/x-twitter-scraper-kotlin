...
private constructor(
    ...
    companion object {
        ...
        fun none(): TweetListByCommunityParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [TweetListByCommunityParams].
         */
        fun builder() = Builder()
    }

    /** A builder for [TweetListByCommunityParams]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [TweetListByCommunityParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TweetListByCommunityParams =
