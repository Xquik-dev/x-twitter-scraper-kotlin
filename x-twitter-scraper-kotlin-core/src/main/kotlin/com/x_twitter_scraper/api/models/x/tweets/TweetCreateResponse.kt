...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(tweetCreateResponse: TweetCreateResponse) = apply {
            id = tweetCreateResponse.id
            account = tweetCreateResponse.account
            action = tweetCreateResponse.action
            billing = tweetCreateResponse.billing
            charged = tweetCreateResponse.charged
            chargedCredits = tweetCreateResponse.chargedCredits
            nextAction = tweetCreateResponse.nextAction
            object_ = tweetCreateResponse.object_
            pollAfterMs = tweetCreateResponse.pollAfterMs
            request = tweetCreateResponse.request
            result = tweetCreateResponse.result
            retryable = tweetCreateResponse.retryable
            safeToRetry = tweetCreateResponse.safeToRetry
            sendDispatched = tweetCreateResponse.sendDispatched
            status = tweetCreateResponse.status
            statusUrl = tweetCreateResponse.statusUrl
            success = tweetCreateResponse.success
            target = tweetCreateResponse.target
            targetId = tweetCreateResponse.targetId
            terminal = tweetCreateResponse.terminal
            writeActionId = tweetCreateResponse.writeActionId
            communityId = tweetCreateResponse.communityId
            communityName = tweetCreateResponse.communityName
            completedAt = tweetCreateResponse.completedAt
            confirmationAttempts = tweetCreateResponse.confirmationAttempts
            confirmationCheckedAt = tweetCreateResponse.confirmationCheckedAt
            confirmedAt = tweetCreateResponse.confirmedAt
            createdAt = tweetCreateResponse.createdAt
            details = tweetCreateResponse.details
            error = tweetCreateResponse.error
            expiresAt = tweetCreateResponse.expiresAt
            idempotent = tweetCreateResponse.idempotent
            media = tweetCreateResponse.media
            mediaId = tweetCreateResponse.mediaId
            mediaUrl = tweetCreateResponse.mediaUrl
            message = tweetCreateResponse.message
            messageId = tweetCreateResponse.messageId
            requestHash = tweetCreateResponse.requestHash
            requestId = tweetCreateResponse.requestId
            resultId = tweetCreateResponse.resultId
            sendDispatchedAt = tweetCreateResponse.sendDispatchedAt
            tweetId = tweetCreateResponse.tweetId
            updatedAt = tweetCreateResponse.updatedAt
