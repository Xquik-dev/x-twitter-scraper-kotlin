...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): EventRetrieveParams =
            EventRetrieveParams(id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EventRetrieveParams &&
            id == other.id &&
    ...
    override fun toString() =
        "EventRetrieveParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
