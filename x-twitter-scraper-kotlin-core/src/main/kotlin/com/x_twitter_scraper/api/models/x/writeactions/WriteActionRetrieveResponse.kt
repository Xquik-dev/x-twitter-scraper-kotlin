...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(writeActionRetrieveResponse: WriteActionRetrieveResponse) = apply {
            id = writeActionRetrieveResponse.id
            account = writeActionRetrieveResponse.account
            ...
            nextAction = writeActionRetrieveResponse.nextAction
            object_ = writeActionRetrieveResponse.object_
            pollAfterMs = writeActionRetrieveResponse.pollAfterMs
            request = writeActionRetrieveResponse.request
            result = writeActionRetrieveResponse.result
            retryable = writeActionRetrieveResponse.retryable
            safeToRetry = writeActionRetrieveResponse.safeToRetry
            sendDispatched = writeActionRetrieveResponse.sendDispatched
            status = writeActionRetrieveResponse.status
            statusUrl = writeActionRetrieveResponse.statusUrl
            success = writeActionRetrieveResponse.success
            target = writeActionRetrieveResponse.target
            targetId = writeActionRetrieveResponse.targetId
            terminal = writeActionRetrieveResponse.terminal
            writeActionId = writeActionRetrieveResponse.writeActionId
            communityId = writeActionRetrieveResponse.communityId
            communityName = writeActionRetrieveResponse.communityName
            completedAt = writeActionRetrieveResponse.completedAt
            ...
            details = writeActionRetrieveResponse.details
            error = writeActionRetrieveResponse.error
            expiresAt = writeActionRetrieveResponse.expiresAt
            idempotent = writeActionRetrieveResponse.idempotent
            media = writeActionRetrieveResponse.media
            mediaId = writeActionRetrieveResponse.mediaId
            mediaUrl = writeActionRetrieveResponse.mediaUrl
            message = writeActionRetrieveResponse.message
            messageId = writeActionRetrieveResponse.messageId
            requestHash = writeActionRetrieveResponse.requestHash
            requestId = writeActionRetrieveResponse.requestId
            resultId = writeActionRetrieveResponse.resultId
            sendDispatchedAt = writeActionRetrieveResponse.sendDispatchedAt
            tweetId = writeActionRetrieveResponse.tweetId
            updatedAt = writeActionRetrieveResponse.updatedAt
