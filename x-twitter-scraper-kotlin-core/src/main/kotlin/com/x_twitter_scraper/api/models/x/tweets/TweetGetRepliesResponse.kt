...
private constructor(
    ...
    internal fun validity(): Int =
        (if (hasNextPage.asKnown() == null) 0 else 1) +
            ...
            (nestedReplies.asKnown()?.sumOf { it.validity().toInt() } ?: 0)
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            fun missingResponseModulesOrFields(
                ...
                this.missingResponseModulesOrFields =
                    missingResponseModulesOrFields.map { it.toMutableList() }
            }
        ...
        internal fun validity(): Int =
            (if (complete.asKnown() == null) 0 else 1) +
                ...
                (strategiesAttempted.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
