...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(webhookDeactivateResponse: WebhookDeactivateResponse) = apply {
            success = webhookDeactivateResponse.success
        ...
        fun build(): WebhookDeactivateResponse =
            WebhookDeactivateResponse(success, additionalProperties.toMutableMap())
    }
    ...
    override fun toString() =
        "WebhookDeactivateResponse{success=$success, additionalProperties=$additionalProperties}"
}
