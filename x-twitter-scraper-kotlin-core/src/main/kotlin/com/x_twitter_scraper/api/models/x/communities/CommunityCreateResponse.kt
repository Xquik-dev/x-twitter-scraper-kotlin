...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(communityCreateResponse: CommunityCreateResponse) = apply {
            id = communityCreateResponse.id
            account = communityCreateResponse.account
            action = communityCreateResponse.action
            billing = communityCreateResponse.billing
            charged = communityCreateResponse.charged
            chargedCredits = communityCreateResponse.chargedCredits
            nextAction = communityCreateResponse.nextAction
            object_ = communityCreateResponse.object_
            pollAfterMs = communityCreateResponse.pollAfterMs
            request = communityCreateResponse.request
            result = communityCreateResponse.result
            retryable = communityCreateResponse.retryable
            safeToRetry = communityCreateResponse.safeToRetry
            sendDispatched = communityCreateResponse.sendDispatched
            status = communityCreateResponse.status
            statusUrl = communityCreateResponse.statusUrl
            success = communityCreateResponse.success
            target = communityCreateResponse.target
            targetId = communityCreateResponse.targetId
            terminal = communityCreateResponse.terminal
            writeActionId = communityCreateResponse.writeActionId
            communityId = communityCreateResponse.communityId
            communityName = communityCreateResponse.communityName
            completedAt = communityCreateResponse.completedAt
            confirmationAttempts = communityCreateResponse.confirmationAttempts
            confirmationCheckedAt = communityCreateResponse.confirmationCheckedAt
            confirmedAt = communityCreateResponse.confirmedAt
            createdAt = communityCreateResponse.createdAt
            details = communityCreateResponse.details
            error = communityCreateResponse.error
            expiresAt = communityCreateResponse.expiresAt
            idempotent = communityCreateResponse.idempotent
            media = communityCreateResponse.media
            mediaId = communityCreateResponse.mediaId
            mediaUrl = communityCreateResponse.mediaUrl
            message = communityCreateResponse.message
            messageId = communityCreateResponse.messageId
            requestHash = communityCreateResponse.requestHash
            requestId = communityCreateResponse.requestId
            resultId = communityCreateResponse.resultId
            sendDispatchedAt = communityCreateResponse.sendDispatchedAt
            tweetId = communityCreateResponse.tweetId
            updatedAt = communityCreateResponse.updatedAt
