...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [KeywordUpdateResponse].
         *
    ...
    /** A builder for [KeywordUpdateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(keywordUpdateResponse: KeywordUpdateResponse) = apply {
            id = keywordUpdateResponse.id
            createdAt = keywordUpdateResponse.createdAt
            eventTypes = keywordUpdateResponse.eventTypes.map { it.toMutableList() }
            isActive = keywordUpdateResponse.isActive
            nextBillingAt = keywordUpdateResponse.nextBillingAt
            query = keywordUpdateResponse.query
            additionalProperties = keywordUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [KeywordUpdateResponse].
         *
         ...
         */
        fun build(): KeywordUpdateResponse =
     ...
     *   its expected type.
     */
    fun validate(): KeywordUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is KeywordUpdateResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "KeywordUpdateResponse{id=$id, createdAt=$createdAt, eventTypes=$eventTypes, isActive=$isActive, nextBillingAt=$nextBillingAt, query=$query, additionalProperties=$additionalProperties}"
}
