...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LikeCreateResponse].
         *
    ...
    /** A builder for [LikeCreateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(likeCreateResponse: LikeCreateResponse) = apply {
            id = likeCreateResponse.id
            account = likeCreateResponse.account
            action = likeCreateResponse.action
            billing = likeCreateResponse.billing
            charged = likeCreateResponse.charged
            chargedCredits = likeCreateResponse.chargedCredits
            nextAction = likeCreateResponse.nextAction
            object_ = likeCreateResponse.object_
            pollAfterMs = likeCreateResponse.pollAfterMs
            request = likeCreateResponse.request
            result = likeCreateResponse.result
            retryable = likeCreateResponse.retryable
            safeToRetry = likeCreateResponse.safeToRetry
            sendDispatched = likeCreateResponse.sendDispatched
            status = likeCreateResponse.status
            statusUrl = likeCreateResponse.statusUrl
            success = likeCreateResponse.success
            target = likeCreateResponse.target
            targetId = likeCreateResponse.targetId
            terminal = likeCreateResponse.terminal
            writeActionId = likeCreateResponse.writeActionId
            communityId = likeCreateResponse.communityId
            communityName = likeCreateResponse.communityName
            completedAt = likeCreateResponse.completedAt
            confirmationAttempts = likeCreateResponse.confirmationAttempts
            confirmationCheckedAt = likeCreateResponse.confirmationCheckedAt
            confirmedAt = likeCreateResponse.confirmedAt
            createdAt = likeCreateResponse.createdAt
            details = likeCreateResponse.details
            error = likeCreateResponse.error
            expiresAt = likeCreateResponse.expiresAt
            idempotent = likeCreateResponse.idempotent
            media = likeCreateResponse.media
            mediaId = likeCreateResponse.mediaId
            mediaUrl = likeCreateResponse.mediaUrl
            message = likeCreateResponse.message
            messageId = likeCreateResponse.messageId
            requestHash = likeCreateResponse.requestHash
            requestId = likeCreateResponse.requestId
            resultId = likeCreateResponse.resultId
            sendDispatchedAt = likeCreateResponse.sendDispatchedAt
            tweetId = likeCreateResponse.tweetId
            updatedAt = likeCreateResponse.updatedAt
            additionalProperties = likeCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LikeCreateResponse].
         *
     ...
     *   its expected type.
     */
    fun validate(): LikeCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LikeCreateResponse &&
            id == other.id &&
