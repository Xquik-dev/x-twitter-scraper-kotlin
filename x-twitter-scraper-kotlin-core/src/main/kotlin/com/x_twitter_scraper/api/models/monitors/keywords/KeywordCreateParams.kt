...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [KeywordCreateParams].
         *
    ...
    /** A builder for [KeywordCreateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(keywordCreateParams: KeywordCreateParams) = apply {
            body = keywordCreateParams.body.toBuilder()
            additionalHeaders = keywordCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = keywordCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [KeywordCreateParams].
         *
    ...
    private constructor(
        ...
        ) : this(eventTypes, query, mutableMapOf())
        ...
        private val hashCode: Int by lazy { Objects.hash(eventTypes, query, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{eventTypes=$eventTypes, query=$query, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is KeywordCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "KeywordCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
