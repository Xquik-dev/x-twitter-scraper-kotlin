...
private constructor(
    ...
    companion object {
        ...
        fun none(): DrawListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [DrawListParams]. */
        fun builder() = Builder()
    }
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [DrawListParams].
         *
