...
class CommunityRetrieveModeratorsResponse
...
private constructor(
    ...
    /** A builder for [CommunityRetrieveModeratorsResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            hasNextPage = communityRetrieveModeratorsResponse.hasNextPage
            nextCursor = communityRetrieveModeratorsResponse.nextCursor
            users = communityRetrieveModeratorsResponse.users.map { it.toMutableList() }
            additionalProperties =
                communityRetrieveModeratorsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CommunityRetrieveModeratorsResponse].
         *
         ...
         */
        fun build(): CommunityRetrieveModeratorsResponse =
            CommunityRetrieveModeratorsResponse(
    ...
    fun validate(): CommunityRetrieveModeratorsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CommunityRetrieveModeratorsResponse &&
    ...
    override fun toString() =
        "CommunityRetrieveModeratorsResponse{hasNextPage=$hasNextPage, nextCursor=$nextCursor, users=$users, additionalProperties=$additionalProperties}"
}
