...
private constructor(
     ...
     *   the server responded with an unexpected value).
     */
    fun messageTemplate(): String? = messageTemplate.getNullable("messageTemplate")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IntegrationUpdateResponse].
         *
    ...
    /** A builder for [IntegrationUpdateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(integrationUpdateResponse: IntegrationUpdateResponse) = apply {
            id = integrationUpdateResponse.id
            config = integrationUpdateResponse.config
            createdAt = integrationUpdateResponse.createdAt
            eventTypes = integrationUpdateResponse.eventTypes.map { it.toMutableList() }
            isActive = integrationUpdateResponse.isActive
            name = integrationUpdateResponse.name
            type = integrationUpdateResponse.type
            filters = integrationUpdateResponse.filters
            messageTemplate = integrationUpdateResponse.messageTemplate
            scopeAllMonitors = integrationUpdateResponse.scopeAllMonitors
            silentPush = integrationUpdateResponse.silentPush
            additionalProperties = integrationUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IntegrationUpdateResponse].
         *
         ...
         */
        fun build(): IntegrationUpdateResponse =
    ...
    fun validate(): IntegrationUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IntegrationUpdateResponse &&
            id == other.id &&
            config == other.config &&
    ...
    override fun toString() =
        "IntegrationUpdateResponse{id=$id, config=$config, createdAt=$createdAt, eventTypes=$eventTypes, isActive=$isActive, name=$name, type=$type, filters=$filters, messageTemplate=$messageTemplate, scopeAllMonitors=$scopeAllMonitors, silentPush=$silentPush, additionalProperties=$additionalProperties}"
}
