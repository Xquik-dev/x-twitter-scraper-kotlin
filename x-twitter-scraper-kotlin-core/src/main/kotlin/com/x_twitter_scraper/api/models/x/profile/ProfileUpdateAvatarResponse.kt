 ...
 * a new key.
 */
class ProfileUpdateAvatarResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ProfileUpdateAvatarResponse].
         *
    ...
    /** A builder for [ProfileUpdateAvatarResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(profileUpdateAvatarResponse: ProfileUpdateAvatarResponse) = apply {
            id = profileUpdateAvatarResponse.id
            account = profileUpdateAvatarResponse.account
            action = profileUpdateAvatarResponse.action
            billing = profileUpdateAvatarResponse.billing
            charged = profileUpdateAvatarResponse.charged
            chargedCredits = profileUpdateAvatarResponse.chargedCredits
            nextAction = profileUpdateAvatarResponse.nextAction
            object_ = profileUpdateAvatarResponse.object_
            pollAfterMs = profileUpdateAvatarResponse.pollAfterMs
            request = profileUpdateAvatarResponse.request
            result = profileUpdateAvatarResponse.result
            retryable = profileUpdateAvatarResponse.retryable
            safeToRetry = profileUpdateAvatarResponse.safeToRetry
            sendDispatched = profileUpdateAvatarResponse.sendDispatched
            status = profileUpdateAvatarResponse.status
            statusUrl = profileUpdateAvatarResponse.statusUrl
            success = profileUpdateAvatarResponse.success
            target = profileUpdateAvatarResponse.target
            targetId = profileUpdateAvatarResponse.targetId
            terminal = profileUpdateAvatarResponse.terminal
            writeActionId = profileUpdateAvatarResponse.writeActionId
            communityId = profileUpdateAvatarResponse.communityId
            communityName = profileUpdateAvatarResponse.communityName
            completedAt = profileUpdateAvatarResponse.completedAt
            confirmationAttempts = profileUpdateAvatarResponse.confirmationAttempts
            confirmationCheckedAt = profileUpdateAvatarResponse.confirmationCheckedAt
            confirmedAt = profileUpdateAvatarResponse.confirmedAt
            createdAt = profileUpdateAvatarResponse.createdAt
            details = profileUpdateAvatarResponse.details
            error = profileUpdateAvatarResponse.error
            expiresAt = profileUpdateAvatarResponse.expiresAt
            idempotent = profileUpdateAvatarResponse.idempotent
            media = profileUpdateAvatarResponse.media
            mediaId = profileUpdateAvatarResponse.mediaId
            mediaUrl = profileUpdateAvatarResponse.mediaUrl
            message = profileUpdateAvatarResponse.message
            messageId = profileUpdateAvatarResponse.messageId
            requestHash = profileUpdateAvatarResponse.requestHash
            requestId = profileUpdateAvatarResponse.requestId
            resultId = profileUpdateAvatarResponse.resultId
            sendDispatchedAt = profileUpdateAvatarResponse.sendDispatchedAt
            tweetId = profileUpdateAvatarResponse.tweetId
            updatedAt = profileUpdateAvatarResponse.updatedAt
            additionalProperties = profileUpdateAvatarResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ProfileUpdateAvatarResponse].
         *
         ...
         */
        fun build(): ProfileUpdateAvatarResponse =
     ...
     *   its expected type.
     */
    fun validate(): ProfileUpdateAvatarResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProfileUpdateAvatarResponse &&
            id == other.id &&
