...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(webhookUpdateResponse: WebhookUpdateResponse) = apply {
            ...
            createdAt = webhookUpdateResponse.createdAt
            eventTypes = webhookUpdateResponse.eventTypes.map { it.toMutableList() }
            isActive = webhookUpdateResponse.isActive
    ...
    override fun toString() =
        "WebhookUpdateResponse{id=$id, createdAt=$createdAt, eventTypes=$eventTypes, isActive=$isActive, url=$url, additionalProperties=$additionalProperties}"
}
