...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TweetGetFavoritersResponse].
         *
    ...
    /** A builder for [TweetGetFavoritersResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(tweetGetFavoritersResponse: TweetGetFavoritersResponse) = apply {
            hasNextPage = tweetGetFavoritersResponse.hasNextPage
            nextCursor = tweetGetFavoritersResponse.nextCursor
            users = tweetGetFavoritersResponse.users.map { it.toMutableList() }
            additionalProperties = tweetGetFavoritersResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TweetGetFavoritersResponse].
         *
         ...
         */
        fun build(): TweetGetFavoritersResponse =
    ...
    fun validate(): TweetGetFavoritersResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TweetGetFavoritersResponse &&
    ...
    override fun toString() =
        "TweetGetFavoritersResponse{hasNextPage=$hasNextPage, nextCursor=$nextCursor, users=$users, additionalProperties=$additionalProperties}"
}
