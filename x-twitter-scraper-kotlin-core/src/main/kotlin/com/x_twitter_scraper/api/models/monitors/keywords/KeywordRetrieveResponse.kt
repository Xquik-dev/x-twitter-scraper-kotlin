...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [KeywordRetrieveResponse].
         *
    ...
    /** A builder for [KeywordRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(keywordRetrieveResponse: KeywordRetrieveResponse) = apply {
            id = keywordRetrieveResponse.id
            createdAt = keywordRetrieveResponse.createdAt
            eventTypes = keywordRetrieveResponse.eventTypes.map { it.toMutableList() }
            isActive = keywordRetrieveResponse.isActive
            nextBillingAt = keywordRetrieveResponse.nextBillingAt
            query = keywordRetrieveResponse.query
            additionalProperties = keywordRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [KeywordRetrieveResponse].
         *
         ...
         */
        fun build(): KeywordRetrieveResponse =
     ...
     *   its expected type.
     */
    fun validate(): KeywordRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is KeywordRetrieveResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "KeywordRetrieveResponse{id=$id, createdAt=$createdAt, eventTypes=$eventTypes, isActive=$isActive, nextBillingAt=$nextBillingAt, query=$query, additionalProperties=$additionalProperties}"
}
