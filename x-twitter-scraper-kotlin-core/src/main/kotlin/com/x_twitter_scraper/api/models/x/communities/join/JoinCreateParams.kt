...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [JoinCreateParams].
         *
    ...
    /** A builder for [JoinCreateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(joinCreateParams: JoinCreateParams) = apply {
            id = joinCreateParams.id
            idempotencyKey = joinCreateParams.idempotencyKey
            body = joinCreateParams.body.toBuilder()
            additionalHeaders = joinCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = joinCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [JoinCreateParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is JoinCreateParams &&
            id == other.id &&
    ...
    override fun toString() =
        "JoinCreateParams{id=$id, idempotencyKey=$idempotencyKey, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
