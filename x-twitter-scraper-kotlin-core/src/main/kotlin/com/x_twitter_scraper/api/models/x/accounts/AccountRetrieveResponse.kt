...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(accountRetrieveResponse: AccountRetrieveResponse) = apply {
            ...
            xUserId = accountRetrieveResponse.xUserId
            xUsername = accountRetrieveResponse.xUsername
            cookiesObtainedAt = accountRetrieveResponse.cookiesObtainedAt
            proxyCountry = accountRetrieveResponse.proxyCountry
    ...
    override fun toString() =
        "AccountRetrieveResponse{id=$id, createdAt=$createdAt, status=$status, xUserId=$xUserId, xUsername=$xUsername, cookiesObtainedAt=$cookiesObtainedAt, proxyCountry=$proxyCountry, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
