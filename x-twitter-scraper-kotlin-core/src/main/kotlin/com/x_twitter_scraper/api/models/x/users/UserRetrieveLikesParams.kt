...
private constructor(
    ...
    companion object {
        ...
        fun none(): UserRetrieveLikesParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [UserRetrieveLikesParams]. */
        fun builder() = Builder()
    }

    /** A builder for [UserRetrieveLikesParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(userRetrieveLikesParams: UserRetrieveLikesParams) = apply {
            id = userRetrieveLikesParams.id
            anyWords = userRetrieveLikesParams.anyWords
            blueVerifiedOnly = userRetrieveLikesParams.blueVerifiedOnly
            cardName = userRetrieveLikesParams.cardName
            cashtags = userRetrieveLikesParams.cashtags
            conversationId = userRetrieveLikesParams.conversationId
            cursor = userRetrieveLikesParams.cursor
            exactPhrase = userRetrieveLikesParams.exactPhrase
            excludeSource = userRetrieveLikesParams.excludeSource
            excludeWords = userRetrieveLikesParams.excludeWords
            fromUser = userRetrieveLikesParams.fromUser
            geocode = userRetrieveLikesParams.geocode
            hashtags = userRetrieveLikesParams.hashtags
            inReplyToTweetId = userRetrieveLikesParams.inReplyToTweetId
            language = userRetrieveLikesParams.language
            maxFaves = userRetrieveLikesParams.maxFaves
            maxId = userRetrieveLikesParams.maxId
            maxQuotes = userRetrieveLikesParams.maxQuotes
            maxReplies = userRetrieveLikesParams.maxReplies
            maxRetweets = userRetrieveLikesParams.maxRetweets
            mediaType = userRetrieveLikesParams.mediaType
            mentioning = userRetrieveLikesParams.mentioning
            minBookmarks = userRetrieveLikesParams.minBookmarks
            minFaves = userRetrieveLikesParams.minFaves
            minQuotes = userRetrieveLikesParams.minQuotes
            minReplies = userRetrieveLikesParams.minReplies
            minRetweets = userRetrieveLikesParams.minRetweets
            minViews = userRetrieveLikesParams.minViews
            nativeRetweets = userRetrieveLikesParams.nativeRetweets
            near = userRetrieveLikesParams.near
            news = userRetrieveLikesParams.news
            pageSize = userRetrieveLikesParams.pageSize
            quotes = userRetrieveLikesParams.quotes
            quotesOfTweetId = userRetrieveLikesParams.quotesOfTweetId
            replies = userRetrieveLikesParams.replies
            retweets = userRetrieveLikesParams.retweets
            retweetsOfTweetId = userRetrieveLikesParams.retweetsOfTweetId
            safe = userRetrieveLikesParams.safe
            sinceDate = userRetrieveLikesParams.sinceDate
            sinceId = userRetrieveLikesParams.sinceId
            source = userRetrieveLikesParams.source
            toUser = userRetrieveLikesParams.toUser
            untilDate = userRetrieveLikesParams.untilDate
            url = userRetrieveLikesParams.url
            verifiedOnly = userRetrieveLikesParams.verifiedOnly
            within = userRetrieveLikesParams.within
            withinTime = userRetrieveLikesParams.withinTime
            additionalHeaders = userRetrieveLikesParams.additionalHeaders.toBuilder()
            additionalQueryParams = userRetrieveLikesParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [UserRetrieveLikesParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UserRetrieveLikesParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserRetrieveLikesParams &&
            id == other.id &&
