...
private constructor(
    ...
    ) : this(id, createdAt, text, updatedAt, goal, topic, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DraftRetrieveResponse].
         *
    ...
    /** A builder for [DraftRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(draftRetrieveResponse: DraftRetrieveResponse) = apply {
            id = draftRetrieveResponse.id
            createdAt = draftRetrieveResponse.createdAt
            text = draftRetrieveResponse.text
            updatedAt = draftRetrieveResponse.updatedAt
            goal = draftRetrieveResponse.goal
            topic = draftRetrieveResponse.topic
            additionalProperties = draftRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DraftRetrieveResponse].
         *
         ...
         */
        fun build(): DraftRetrieveResponse =
    ...
    fun validate(): DraftRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DraftRetrieveResponse &&
            id == other.id &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, createdAt, text, updatedAt, goal, topic, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "DraftRetrieveResponse{id=$id, createdAt=$createdAt, text=$text, updatedAt=$updatedAt, goal=$goal, topic=$topic, additionalProperties=$additionalProperties}"
}
