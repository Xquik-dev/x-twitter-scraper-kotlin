...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ApiKeyRevokeResponse]. */
        fun builder() = Builder()
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(apiKeyRevokeResponse: ApiKeyRevokeResponse) = apply {
            success = apiKeyRevokeResponse.success
        ...
        /**
         * Returns an immutable instance of [ApiKeyRevokeResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ApiKeyRevokeResponse =
            ApiKeyRevokeResponse(success, additionalProperties.toMutableMap())
    }
     ...
     *   its expected type.
     */
    fun validate(): ApiKeyRevokeResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "ApiKeyRevokeResponse{success=$success, additionalProperties=$additionalProperties}"
}
