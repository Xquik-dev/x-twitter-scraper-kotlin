...
private constructor(
    ...
    /** A builder for [DrawExportParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(drawExportParams: DrawExportParams) = apply {
            id = drawExportParams.id
            format = drawExportParams.format
            type = drawExportParams.type
            additionalHeaders = drawExportParams.additionalHeaders.toBuilder()
            additionalQueryParams = drawExportParams.additionalQueryParams.toBuilder()
        }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val WINNERS = of("winners")

            val ENTRIES = of("entries")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DrawExportParams &&
            id == other.id &&
            format == other.format &&
            type == other.type &&
    ...
    override fun hashCode(): Int =
        Objects.hash(id, format, type, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "DrawExportParams{id=$id, format=$format, type=$type, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
