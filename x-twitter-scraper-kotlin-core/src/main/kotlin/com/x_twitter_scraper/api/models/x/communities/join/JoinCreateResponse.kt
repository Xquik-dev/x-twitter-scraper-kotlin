...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(joinCreateResponse: JoinCreateResponse) = apply {
            id = joinCreateResponse.id
            account = joinCreateResponse.account
            action = joinCreateResponse.action
            billing = joinCreateResponse.billing
            charged = joinCreateResponse.charged
            chargedCredits = joinCreateResponse.chargedCredits
            nextAction = joinCreateResponse.nextAction
            object_ = joinCreateResponse.object_
            pollAfterMs = joinCreateResponse.pollAfterMs
            request = joinCreateResponse.request
            result = joinCreateResponse.result
            retryable = joinCreateResponse.retryable
            safeToRetry = joinCreateResponse.safeToRetry
            sendDispatched = joinCreateResponse.sendDispatched
            status = joinCreateResponse.status
            statusUrl = joinCreateResponse.statusUrl
            success = joinCreateResponse.success
            target = joinCreateResponse.target
            targetId = joinCreateResponse.targetId
            terminal = joinCreateResponse.terminal
            writeActionId = joinCreateResponse.writeActionId
            communityId = joinCreateResponse.communityId
            communityName = joinCreateResponse.communityName
            completedAt = joinCreateResponse.completedAt
            confirmationAttempts = joinCreateResponse.confirmationAttempts
            confirmationCheckedAt = joinCreateResponse.confirmationCheckedAt
            confirmedAt = joinCreateResponse.confirmedAt
            createdAt = joinCreateResponse.createdAt
            details = joinCreateResponse.details
            error = joinCreateResponse.error
            expiresAt = joinCreateResponse.expiresAt
            idempotent = joinCreateResponse.idempotent
            media = joinCreateResponse.media
            mediaId = joinCreateResponse.mediaId
            mediaUrl = joinCreateResponse.mediaUrl
            message = joinCreateResponse.message
            messageId = joinCreateResponse.messageId
            requestHash = joinCreateResponse.requestHash
            requestId = joinCreateResponse.requestId
            resultId = joinCreateResponse.resultId
            sendDispatchedAt = joinCreateResponse.sendDispatchedAt
            tweetId = joinCreateResponse.tweetId
            updatedAt = joinCreateResponse.updatedAt
