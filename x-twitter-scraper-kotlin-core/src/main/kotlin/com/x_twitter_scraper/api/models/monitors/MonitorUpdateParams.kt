...
private constructor(
    ...
    companion object {
        ...
        fun none(): MonitorUpdateParams = builder().build()
    ...
    override fun toString() =
        "MonitorUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
