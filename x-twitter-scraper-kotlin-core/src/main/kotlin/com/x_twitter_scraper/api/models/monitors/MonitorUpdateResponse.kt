...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MonitorUpdateResponse].
         *
    ...
    /** A builder for [MonitorUpdateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(monitorUpdateResponse: MonitorUpdateResponse) = apply {
            id = monitorUpdateResponse.id
            createdAt = monitorUpdateResponse.createdAt
            eventTypes = monitorUpdateResponse.eventTypes.map { it.toMutableList() }
            isActive = monitorUpdateResponse.isActive
            username = monitorUpdateResponse.username
            xUserId = monitorUpdateResponse.xUserId
            additionalProperties = monitorUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MonitorUpdateResponse].
         *
         ...
         */
        fun build(): MonitorUpdateResponse =
    ...
    fun validate(): MonitorUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MonitorUpdateResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "MonitorUpdateResponse{id=$id, createdAt=$createdAt, eventTypes=$eventTypes, isActive=$isActive, username=$username, xUserId=$xUserId, additionalProperties=$additionalProperties}"
}
