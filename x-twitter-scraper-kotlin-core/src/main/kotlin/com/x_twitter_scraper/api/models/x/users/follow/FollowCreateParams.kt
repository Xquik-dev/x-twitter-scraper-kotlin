...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FollowCreateParams].
         *
    ...
    /** A builder for [FollowCreateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(followCreateParams: FollowCreateParams) = apply {
            userId = followCreateParams.userId
        ...
        /**
         * Returns an immutable instance of [FollowCreateParams].
         *
    ...
    override fun toString() =
        "FollowCreateParams{userId=$userId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
