...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TweetGetThreadResponse].
         *
    ...
    /** A builder for [TweetGetThreadResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(tweetGetThreadResponse: TweetGetThreadResponse) = apply {
            hasNextPage = tweetGetThreadResponse.hasNextPage
            nextCursor = tweetGetThreadResponse.nextCursor
            tweets = tweetGetThreadResponse.tweets.map { it.toMutableList() }
            additionalProperties = tweetGetThreadResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TweetGetThreadResponse].
         *
         ...
         */
        fun build(): TweetGetThreadResponse =
    ...
    fun validate(): TweetGetThreadResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TweetGetThreadResponse &&
    ...
    override fun toString() =
        "TweetGetThreadResponse{hasNextPage=$hasNextPage, nextCursor=$nextCursor, tweets=$tweets, additionalProperties=$additionalProperties}"
}
