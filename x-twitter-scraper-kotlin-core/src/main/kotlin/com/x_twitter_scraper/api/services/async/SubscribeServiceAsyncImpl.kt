...
class SubscribeServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): SubscribeServiceAsync =
        SubscribeServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())
