...
class PlatformLinkDeleteParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PlatformLinkDeleteParams].
         *
    ...
    /** A builder for [PlatformLinkDeleteParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(platformLinkDeleteParams: PlatformLinkDeleteParams) = apply {
            body = platformLinkDeleteParams.body.toBuilder()
            additionalHeaders = platformLinkDeleteParams.additionalHeaders.toBuilder()
            additionalQueryParams = platformLinkDeleteParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PlatformLinkDeleteParams].
         *
         ...
         */
        fun build(): PlatformLinkDeleteParams =
    ...
    private constructor(
        ...
        ) : this(platform, platformUserId, mutableMapOf())
        ...
        internal fun validity(): Int =
            (platform.asKnown()?.validity() ?: 0) + (if (platformUserId.asKnown() == null) 0 else 1)
        ...
        private val hashCode: Int by lazy {
            Objects.hash(platform, platformUserId, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{platform=$platform, platformUserId=$platformUserId, additionalProperties=$additionalProperties}"
    }
    ...
    class Platform @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        fun known(): Known =
            when (this) {
                ...
                else -> throw XTwitterScraperInvalidDataException("Unknown Platform: $value")
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PlatformLinkDeleteParams &&
            body == other.body &&
    ...
    override fun toString() =
        "PlatformLinkDeleteParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
