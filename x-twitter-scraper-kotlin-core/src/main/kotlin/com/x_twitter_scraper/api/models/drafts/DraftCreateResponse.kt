...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DraftCreateResponse].
         *
    ...
    /** A builder for [DraftCreateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(draftCreateResponse: DraftCreateResponse) = apply {
            id = draftCreateResponse.id
            createdAt = draftCreateResponse.createdAt
            text = draftCreateResponse.text
            updatedAt = draftCreateResponse.updatedAt
            goal = draftCreateResponse.goal
            topic = draftCreateResponse.topic
            additionalProperties = draftCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DraftCreateResponse].
         *
    ...
    fun validate(): DraftCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DraftCreateResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "DraftCreateResponse{id=$id, createdAt=$createdAt, text=$text, updatedAt=$updatedAt, goal=$goal, topic=$topic, additionalProperties=$additionalProperties}"
}
