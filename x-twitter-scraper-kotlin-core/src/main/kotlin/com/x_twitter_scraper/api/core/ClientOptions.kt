...
private constructor(
     ...
     *
     * Use the one published in `x-twitter-scraper-kotlin-client-okhttp` or implement your own.
     *
     ...
     *
     * Defaults to [com.x_twitter_scraper.api.core.jsonMapper]. The default is usually sufficient
    ...
    companion object {
        ...
        const val PRODUCTION_URL = "https://xquik.com/api/v1"
    ...
    class Builder internal constructor() {
        ...
        fun fromEnv() = apply {
            ...
            (System.getProperty("xtwitterscraper.baseUrl")
                ...
                ?.let { baseUrl(it) }
            (System.getProperty("xtwitterscraper.apiKey")
                    ?: System.getenv("X_TWITTER_SCRAPER_API_KEY"))
                ?.let { apiKey(it) }
            (System.getProperty("xtwitterscraper.bearerToken")
                    ?: System.getenv("X_TWITTER_SCRAPER_BEARER_TOKEN"))
                ?.let { bearerToken(it) }
            System.getenv("X_TWITTER_SCRAPER_CUSTOM_HEADERS")?.let { customHeadersEnv ->
