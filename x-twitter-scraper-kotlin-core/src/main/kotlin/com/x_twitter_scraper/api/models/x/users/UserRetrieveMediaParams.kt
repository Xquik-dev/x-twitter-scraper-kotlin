...
private constructor(
    ...
    companion object {
        ...
        fun none(): UserRetrieveMediaParams = builder().build()
    ...
    override fun toString() =
        "UserRetrieveMediaParams{id=$id, cursor=$cursor, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
