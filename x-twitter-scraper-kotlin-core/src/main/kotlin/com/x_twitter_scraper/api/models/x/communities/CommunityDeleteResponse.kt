...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CommunityDeleteResponse].
         *
    ...
    /** A builder for [CommunityDeleteResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(communityDeleteResponse: CommunityDeleteResponse) = apply {
            id = communityDeleteResponse.id
            account = communityDeleteResponse.account
            action = communityDeleteResponse.action
            billing = communityDeleteResponse.billing
            charged = communityDeleteResponse.charged
            chargedCredits = communityDeleteResponse.chargedCredits
            nextAction = communityDeleteResponse.nextAction
            object_ = communityDeleteResponse.object_
            pollAfterMs = communityDeleteResponse.pollAfterMs
            request = communityDeleteResponse.request
            result = communityDeleteResponse.result
            retryable = communityDeleteResponse.retryable
            safeToRetry = communityDeleteResponse.safeToRetry
            sendDispatched = communityDeleteResponse.sendDispatched
            status = communityDeleteResponse.status
            statusUrl = communityDeleteResponse.statusUrl
            success = communityDeleteResponse.success
            target = communityDeleteResponse.target
            targetId = communityDeleteResponse.targetId
            terminal = communityDeleteResponse.terminal
            writeActionId = communityDeleteResponse.writeActionId
            communityId = communityDeleteResponse.communityId
            communityName = communityDeleteResponse.communityName
            completedAt = communityDeleteResponse.completedAt
            confirmationAttempts = communityDeleteResponse.confirmationAttempts
            confirmationCheckedAt = communityDeleteResponse.confirmationCheckedAt
            confirmedAt = communityDeleteResponse.confirmedAt
            createdAt = communityDeleteResponse.createdAt
            details = communityDeleteResponse.details
            error = communityDeleteResponse.error
            expiresAt = communityDeleteResponse.expiresAt
            idempotent = communityDeleteResponse.idempotent
            media = communityDeleteResponse.media
            mediaId = communityDeleteResponse.mediaId
            mediaUrl = communityDeleteResponse.mediaUrl
            message = communityDeleteResponse.message
            messageId = communityDeleteResponse.messageId
            requestHash = communityDeleteResponse.requestHash
            requestId = communityDeleteResponse.requestId
            resultId = communityDeleteResponse.resultId
            sendDispatchedAt = communityDeleteResponse.sendDispatchedAt
            tweetId = communityDeleteResponse.tweetId
            updatedAt = communityDeleteResponse.updatedAt
            additionalProperties = communityDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CommunityDeleteResponse].
         *
         ...
         */
        fun build(): CommunityDeleteResponse =
     ...
     *   its expected type.
     */
    fun validate(): CommunityDeleteResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CommunityDeleteResponse &&
            id == other.id &&
