...
private constructor(
    ...
    companion object {
        ...
        fun none(): StyleRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [StyleRetrieveParams]. */
        fun builder() = Builder()
    }
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [StyleRetrieveParams].
         *
