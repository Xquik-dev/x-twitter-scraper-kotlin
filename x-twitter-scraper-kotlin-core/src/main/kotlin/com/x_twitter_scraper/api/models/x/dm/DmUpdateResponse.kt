...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DmUpdateResponse].
         *
    ...
    /** A builder for [DmUpdateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(dmUpdateResponse: DmUpdateResponse) = apply {
            messageId = dmUpdateResponse.messageId
            success = dmUpdateResponse.success
            additionalProperties = dmUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DmUpdateResponse].
         *
    ...
    fun validate(): DmUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DmUpdateResponse &&
    ...
    override fun toString() =
        "DmUpdateResponse{messageId=$messageId, success=$success, additionalProperties=$additionalProperties}"
}
