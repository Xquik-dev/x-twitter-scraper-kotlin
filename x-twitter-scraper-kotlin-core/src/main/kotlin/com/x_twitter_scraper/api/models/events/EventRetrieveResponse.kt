...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(eventRetrieveResponse: EventRetrieveResponse) = apply {
            id = eventRetrieveResponse.id
            data = eventRetrieveResponse.data
            monitorId = eventRetrieveResponse.monitorId
            occurredAt = eventRetrieveResponse.occurredAt
            type = eventRetrieveResponse.type
            username = eventRetrieveResponse.username
            xEventId = eventRetrieveResponse.xEventId
    ...
    override fun toString() =
        "EventRetrieveResponse{id=$id, data=$data, monitorId=$monitorId, occurredAt=$occurredAt, type=$type, username=$username, xEventId=$xEventId, additionalProperties=$additionalProperties}"
}
