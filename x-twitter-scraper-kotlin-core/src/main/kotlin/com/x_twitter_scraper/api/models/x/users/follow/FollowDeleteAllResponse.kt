...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FollowDeleteAllResponse].
         *
    ...
    /** A builder for [FollowDeleteAllResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(followDeleteAllResponse: FollowDeleteAllResponse) = apply {
            id = followDeleteAllResponse.id
            account = followDeleteAllResponse.account
            action = followDeleteAllResponse.action
            billing = followDeleteAllResponse.billing
            charged = followDeleteAllResponse.charged
            chargedCredits = followDeleteAllResponse.chargedCredits
            nextAction = followDeleteAllResponse.nextAction
            object_ = followDeleteAllResponse.object_
            pollAfterMs = followDeleteAllResponse.pollAfterMs
            request = followDeleteAllResponse.request
            result = followDeleteAllResponse.result
            retryable = followDeleteAllResponse.retryable
            safeToRetry = followDeleteAllResponse.safeToRetry
            sendDispatched = followDeleteAllResponse.sendDispatched
            status = followDeleteAllResponse.status
            statusUrl = followDeleteAllResponse.statusUrl
            success = followDeleteAllResponse.success
            target = followDeleteAllResponse.target
            targetId = followDeleteAllResponse.targetId
            terminal = followDeleteAllResponse.terminal
            writeActionId = followDeleteAllResponse.writeActionId
            communityId = followDeleteAllResponse.communityId
            communityName = followDeleteAllResponse.communityName
            completedAt = followDeleteAllResponse.completedAt
            confirmationAttempts = followDeleteAllResponse.confirmationAttempts
            confirmationCheckedAt = followDeleteAllResponse.confirmationCheckedAt
            confirmedAt = followDeleteAllResponse.confirmedAt
            createdAt = followDeleteAllResponse.createdAt
            details = followDeleteAllResponse.details
            error = followDeleteAllResponse.error
            expiresAt = followDeleteAllResponse.expiresAt
            idempotent = followDeleteAllResponse.idempotent
            media = followDeleteAllResponse.media
            mediaId = followDeleteAllResponse.mediaId
            mediaUrl = followDeleteAllResponse.mediaUrl
            message = followDeleteAllResponse.message
            messageId = followDeleteAllResponse.messageId
            requestHash = followDeleteAllResponse.requestHash
            requestId = followDeleteAllResponse.requestId
            resultId = followDeleteAllResponse.resultId
            sendDispatchedAt = followDeleteAllResponse.sendDispatchedAt
            tweetId = followDeleteAllResponse.tweetId
            updatedAt = followDeleteAllResponse.updatedAt
            additionalProperties = followDeleteAllResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FollowDeleteAllResponse].
         *
         ...
         */
        fun build(): FollowDeleteAllResponse =
     ...
     *   its expected type.
     */
    fun validate(): FollowDeleteAllResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FollowDeleteAllResponse &&
            id == other.id &&
