...
/**
 * A class that allows building an instance of [XTwitterScraperClientAsync] with [OkHttpClient] as
 * the underlying [HttpClient].
 */
class XTwitterScraperOkHttpClientAsync private constructor() {

    companion object {

        /**
         * Returns a mutable builder for constructing an instance of [XTwitterScraperClientAsync].
         */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): XTwitterScraperClientAsync = builder().fromEnv().build()
    }

    /** A builder for [XTwitterScraperOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.x_twitter_scraper.api.core.jsonMapper]. The default is usually
         ...
         *
         * Defaults to the production environment: `https://xquik.com/api/v1`.
         */
        ...
        /**
         * Returns an immutable instance of [XTwitterScraperClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): XTwitterScraperClientAsync =
            XTwitterScraperClientAsyncImpl(
                clientOptions
                    .httpClient(
