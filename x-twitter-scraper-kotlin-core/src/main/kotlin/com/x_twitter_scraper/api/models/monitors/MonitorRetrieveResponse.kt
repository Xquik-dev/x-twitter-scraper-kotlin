...
private constructor(
    ...
    /** A builder for [MonitorRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(monitorRetrieveResponse: MonitorRetrieveResponse) = apply {
            id = monitorRetrieveResponse.id
            createdAt = monitorRetrieveResponse.createdAt
            eventTypes = monitorRetrieveResponse.eventTypes.map { it.toMutableList() }
            isActive = monitorRetrieveResponse.isActive
            username = monitorRetrieveResponse.username
            xUserId = monitorRetrieveResponse.xUserId
        ...
        /**
         * Returns an immutable instance of [MonitorRetrieveResponse].
         *
         ...
         */
        fun build(): MonitorRetrieveResponse =
    ...
    fun validate(): MonitorRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "MonitorRetrieveResponse{id=$id, createdAt=$createdAt, eventTypes=$eventTypes, isActive=$isActive, username=$username, xUserId=$xUserId, additionalProperties=$additionalProperties}"
}
