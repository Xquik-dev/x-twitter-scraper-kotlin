 ...
 * a new key.
 */
class ProfileUpdateBannerResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ProfileUpdateBannerResponse].
         *
    ...
    /** A builder for [ProfileUpdateBannerResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(profileUpdateBannerResponse: ProfileUpdateBannerResponse) = apply {
            id = profileUpdateBannerResponse.id
            account = profileUpdateBannerResponse.account
            action = profileUpdateBannerResponse.action
            billing = profileUpdateBannerResponse.billing
            charged = profileUpdateBannerResponse.charged
            chargedCredits = profileUpdateBannerResponse.chargedCredits
            nextAction = profileUpdateBannerResponse.nextAction
            object_ = profileUpdateBannerResponse.object_
            pollAfterMs = profileUpdateBannerResponse.pollAfterMs
            request = profileUpdateBannerResponse.request
            result = profileUpdateBannerResponse.result
            retryable = profileUpdateBannerResponse.retryable
            safeToRetry = profileUpdateBannerResponse.safeToRetry
            sendDispatched = profileUpdateBannerResponse.sendDispatched
            status = profileUpdateBannerResponse.status
            statusUrl = profileUpdateBannerResponse.statusUrl
            success = profileUpdateBannerResponse.success
            target = profileUpdateBannerResponse.target
            targetId = profileUpdateBannerResponse.targetId
            terminal = profileUpdateBannerResponse.terminal
            writeActionId = profileUpdateBannerResponse.writeActionId
            communityId = profileUpdateBannerResponse.communityId
            communityName = profileUpdateBannerResponse.communityName
            completedAt = profileUpdateBannerResponse.completedAt
            confirmationAttempts = profileUpdateBannerResponse.confirmationAttempts
            confirmationCheckedAt = profileUpdateBannerResponse.confirmationCheckedAt
            confirmedAt = profileUpdateBannerResponse.confirmedAt
            createdAt = profileUpdateBannerResponse.createdAt
            details = profileUpdateBannerResponse.details
            error = profileUpdateBannerResponse.error
            expiresAt = profileUpdateBannerResponse.expiresAt
            idempotent = profileUpdateBannerResponse.idempotent
            media = profileUpdateBannerResponse.media
            mediaId = profileUpdateBannerResponse.mediaId
            mediaUrl = profileUpdateBannerResponse.mediaUrl
            message = profileUpdateBannerResponse.message
            messageId = profileUpdateBannerResponse.messageId
            requestHash = profileUpdateBannerResponse.requestHash
            requestId = profileUpdateBannerResponse.requestId
            resultId = profileUpdateBannerResponse.resultId
            sendDispatchedAt = profileUpdateBannerResponse.sendDispatchedAt
            tweetId = profileUpdateBannerResponse.tweetId
            updatedAt = profileUpdateBannerResponse.updatedAt
            additionalProperties = profileUpdateBannerResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ProfileUpdateBannerResponse].
         *
         ...
         */
        fun build(): ProfileUpdateBannerResponse =
     ...
     *   its expected type.
     */
    fun validate(): ProfileUpdateBannerResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProfileUpdateBannerResponse &&
            id == other.id &&
