...
class ListRetrieveMembersResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ListRetrieveMembersResponse].
         *
    ...
    /** A builder for [ListRetrieveMembersResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(listRetrieveMembersResponse: ListRetrieveMembersResponse) = apply {
            hasNextPage = listRetrieveMembersResponse.hasNextPage
            nextCursor = listRetrieveMembersResponse.nextCursor
            users = listRetrieveMembersResponse.users.map { it.toMutableList() }
            additionalProperties = listRetrieveMembersResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ListRetrieveMembersResponse].
         *
         ...
         */
        fun build(): ListRetrieveMembersResponse =
    ...
    fun validate(): ListRetrieveMembersResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ListRetrieveMembersResponse &&
    ...
    override fun toString() =
        "ListRetrieveMembersResponse{hasNextPage=$hasNextPage, nextCursor=$nextCursor, users=$users, additionalProperties=$additionalProperties}"
}
