...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GuestWalletCreateParams].
         *
    ...
    /** A builder for [GuestWalletCreateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(guestWalletCreateParams: GuestWalletCreateParams) = apply {
            idempotencyKey = guestWalletCreateParams.idempotencyKey
            body = guestWalletCreateParams.body.toBuilder()
            additionalHeaders = guestWalletCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = guestWalletCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [GuestWalletCreateParams].
         *
         ...
         */
        fun build(): GuestWalletCreateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GuestWalletCreateParams &&
    ...
    override fun toString() =
        "GuestWalletCreateParams{idempotencyKey=$idempotencyKey, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
