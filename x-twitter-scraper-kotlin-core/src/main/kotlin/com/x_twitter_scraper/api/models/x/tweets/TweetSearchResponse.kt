...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TweetSearchResponse].
         *
    ...
    /** A builder for [TweetSearchResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(tweetSearchResponse: TweetSearchResponse) = apply {
            hasNextPage = tweetSearchResponse.hasNextPage
            nextCursor = tweetSearchResponse.nextCursor
            tweets = tweetSearchResponse.tweets.map { it.toMutableList() }
            additionalProperties = tweetSearchResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TweetSearchResponse].
         *
    ...
    override fun toString() =
        "TweetSearchResponse{hasNextPage=$hasNextPage, nextCursor=$nextCursor, tweets=$tweets, additionalProperties=$additionalProperties}"
}
