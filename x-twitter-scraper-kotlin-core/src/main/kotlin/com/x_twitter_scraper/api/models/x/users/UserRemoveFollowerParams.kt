...
/** Remove follower */
class UserRemoveFollowerParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UserRemoveFollowerParams].
         *
    ...
    /** A builder for [UserRemoveFollowerParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(userRemoveFollowerParams: UserRemoveFollowerParams) = apply {
            id = userRemoveFollowerParams.id
            idempotencyKey = userRemoveFollowerParams.idempotencyKey
            body = userRemoveFollowerParams.body.toBuilder()
            additionalHeaders = userRemoveFollowerParams.additionalHeaders.toBuilder()
            additionalQueryParams = userRemoveFollowerParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [UserRemoveFollowerParams].
         *
         ...
         */
        fun build(): UserRemoveFollowerParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserRemoveFollowerParams &&
            id == other.id &&
    ...
    override fun toString() =
        "UserRemoveFollowerParams{id=$id, idempotencyKey=$idempotencyKey, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
