...
class UserRetrieveMediaResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UserRetrieveMediaResponse].
         *
    ...
    /** A builder for [UserRetrieveMediaResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(userRetrieveMediaResponse: UserRetrieveMediaResponse) = apply {
            hasNextPage = userRetrieveMediaResponse.hasNextPage
            nextCursor = userRetrieveMediaResponse.nextCursor
            tweets = userRetrieveMediaResponse.tweets.map { it.toMutableList() }
            additionalProperties = userRetrieveMediaResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UserRetrieveMediaResponse].
         *
         ...
         */
        fun build(): UserRetrieveMediaResponse =
    ...
    fun validate(): UserRetrieveMediaResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserRetrieveMediaResponse &&
    ...
    override fun toString() =
        "UserRetrieveMediaResponse{hasNextPage=$hasNextPage, nextCursor=$nextCursor, tweets=$tweets, additionalProperties=$additionalProperties}"
}
