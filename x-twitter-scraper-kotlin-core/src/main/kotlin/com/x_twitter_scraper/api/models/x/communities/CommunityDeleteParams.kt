...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun communityName(): String = body.communityName()
     ...
     */
    fun _communityName(): JsonField<String> = body._communityName()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CommunityDeleteParams].
         *
    ...
    /** A builder for [CommunityDeleteParams]. */
    class Builder internal constructor() {
        ...
        /** Community name for confirmation */
        fun communityName(communityName: String) = apply { body.communityName(communityName) }
        ...
        /**
         * Returns an immutable instance of [CommunityDeleteParams].
         *
    ...
    private constructor(
         ...
         *   value).
         */
        fun communityName(): String = communityName.getRequired("community_name")
         ...
         * Returns the raw JSON value of [communityName].
         *
         * Unlike [communityName], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("community_name")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             * Sets [Builder.communityName] to an arbitrary JSON value.
             *
             * You should usually call [Builder.communityName] with a well-typed [String] value
        ...
        private val hashCode: Int by lazy {
            Objects.hash(account, communityName, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{account=$account, communityName=$communityName, additionalProperties=$additionalProperties}"
    }
