...
class CommunityRetrieveMembersParams
private constructor(
    ...
    companion object {
        ...
        fun none(): CommunityRetrieveMembersParams = builder().build()
    ...
    /** A builder for [CommunityRetrieveMembersParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(communityRetrieveMembersParams: CommunityRetrieveMembersParams) = apply {
            ...
            bioContains = communityRetrieveMembersParams.bioContains
            cursor = communityRetrieveMembersParams.cursor
            hasLocation = communityRetrieveMembersParams.hasLocation
            hasWebsite = communityRetrieveMembersParams.hasWebsite
            locationContains = communityRetrieveMembersParams.locationContains
            maxFollowers = communityRetrieveMembersParams.maxFollowers
            maxFollowing = communityRetrieveMembersParams.maxFollowing
            maxStatuses = communityRetrieveMembersParams.maxStatuses
            minAccountAgeDays = communityRetrieveMembersParams.minAccountAgeDays
            minFollowers = communityRetrieveMembersParams.minFollowers
            minFollowing = communityRetrieveMembersParams.minFollowing
            minStatuses = communityRetrieveMembersParams.minStatuses
            pageSize = communityRetrieveMembersParams.pageSize
            usernameContains = communityRetrieveMembersParams.usernameContains
            verifiedOnly = communityRetrieveMembersParams.verifiedOnly
            verifiedType = communityRetrieveMembersParams.verifiedType
        ...
        /**
         * Returns an immutable instance of [CommunityRetrieveMembersParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CommunityRetrieveMembersParams =
            CommunityRetrieveMembersParams(
                id,
                bioContains,
                cursor,
    ...
    override fun toString() =
        "CommunityRetrieveMembersParams{id=$id, bioContains=$bioContains, cursor=$cursor, hasLocation=$hasLocation, hasWebsite=$hasWebsite, locationContains=$locationContains, maxFollowers=$maxFollowers, maxFollowing=$maxFollowing, maxStatuses=$maxStatuses, minAccountAgeDays=$minAccountAgeDays, minFollowers=$minFollowers, minFollowing=$minFollowing, minStatuses=$minStatuses, pageSize=$pageSize, usernameContains=$usernameContains, verifiedOnly=$verifiedOnly, verifiedType=$verifiedType, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
