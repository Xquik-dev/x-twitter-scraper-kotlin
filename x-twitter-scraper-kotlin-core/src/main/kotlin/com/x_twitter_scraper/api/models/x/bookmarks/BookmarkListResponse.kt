...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BookmarkListResponse].
         *
    ...
    /** A builder for [BookmarkListResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(bookmarkListResponse: BookmarkListResponse) = apply {
            hasNextPage = bookmarkListResponse.hasNextPage
            nextCursor = bookmarkListResponse.nextCursor
            tweets = bookmarkListResponse.tweets.map { it.toMutableList() }
            additionalProperties = bookmarkListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BookmarkListResponse].
         *
         ...
         */
        fun build(): BookmarkListResponse =
    ...
    fun validate(): BookmarkListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BookmarkListResponse &&
    ...
    override fun toString() =
        "BookmarkListResponse{hasNextPage=$hasNextPage, nextCursor=$nextCursor, tweets=$tweets, additionalProperties=$additionalProperties}"
}
