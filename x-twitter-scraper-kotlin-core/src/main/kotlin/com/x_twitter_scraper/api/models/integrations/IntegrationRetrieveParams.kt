...
private constructor(
    ...
    companion object {
        ...
        fun none(): IntegrationRetrieveParams = builder().build()
    ...
    /** A builder for [IntegrationRetrieveParams]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [IntegrationRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): IntegrationRetrieveParams =
            IntegrationRetrieveParams(id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "IntegrationRetrieveParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
