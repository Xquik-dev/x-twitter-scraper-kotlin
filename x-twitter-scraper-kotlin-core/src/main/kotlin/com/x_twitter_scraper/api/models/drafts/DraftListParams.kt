...
private constructor(
    ...
    companion object {
        ...
        fun none(): DraftListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(draftListParams: DraftListParams) = apply {
            afterCursor = draftListParams.afterCursor
            limit = draftListParams.limit
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                afterCursor?.let { put("afterCursor", it) }
    ...
    override fun hashCode(): Int =
        Objects.hash(afterCursor, limit, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "DraftListParams{afterCursor=$afterCursor, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
