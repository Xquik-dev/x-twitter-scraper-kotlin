...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(profileUpdateResponse: ProfileUpdateResponse) = apply {
            id = profileUpdateResponse.id
            account = profileUpdateResponse.account
            action = profileUpdateResponse.action
            billing = profileUpdateResponse.billing
            charged = profileUpdateResponse.charged
            chargedCredits = profileUpdateResponse.chargedCredits
            nextAction = profileUpdateResponse.nextAction
            object_ = profileUpdateResponse.object_
            pollAfterMs = profileUpdateResponse.pollAfterMs
            request = profileUpdateResponse.request
            result = profileUpdateResponse.result
            retryable = profileUpdateResponse.retryable
            safeToRetry = profileUpdateResponse.safeToRetry
            sendDispatched = profileUpdateResponse.sendDispatched
            status = profileUpdateResponse.status
            statusUrl = profileUpdateResponse.statusUrl
            success = profileUpdateResponse.success
            target = profileUpdateResponse.target
            targetId = profileUpdateResponse.targetId
            terminal = profileUpdateResponse.terminal
            writeActionId = profileUpdateResponse.writeActionId
            communityId = profileUpdateResponse.communityId
            communityName = profileUpdateResponse.communityName
            completedAt = profileUpdateResponse.completedAt
            confirmationAttempts = profileUpdateResponse.confirmationAttempts
            confirmationCheckedAt = profileUpdateResponse.confirmationCheckedAt
            confirmedAt = profileUpdateResponse.confirmedAt
            createdAt = profileUpdateResponse.createdAt
            details = profileUpdateResponse.details
            error = profileUpdateResponse.error
            expiresAt = profileUpdateResponse.expiresAt
            idempotent = profileUpdateResponse.idempotent
            media = profileUpdateResponse.media
            mediaId = profileUpdateResponse.mediaId
            mediaUrl = profileUpdateResponse.mediaUrl
            message = profileUpdateResponse.message
            messageId = profileUpdateResponse.messageId
            requestHash = profileUpdateResponse.requestHash
            requestId = profileUpdateResponse.requestId
            resultId = profileUpdateResponse.resultId
            sendDispatchedAt = profileUpdateResponse.sendDispatchedAt
            tweetId = profileUpdateResponse.tweetId
            updatedAt = profileUpdateResponse.updatedAt
