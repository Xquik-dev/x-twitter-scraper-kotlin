...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LikeDeleteParams].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(likeDeleteParams: LikeDeleteParams) = apply {
            ...
            idempotencyKey = likeDeleteParams.idempotencyKey
        ...
        /**
         * Returns an immutable instance of [LikeDeleteParams].
         *
    ...
    override fun toString() =
        "LikeDeleteParams{id=$id, idempotencyKey=$idempotencyKey, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
