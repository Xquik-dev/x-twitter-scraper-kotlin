    ...
    fun create() {
        val guestWalletCreateResponse =
            GuestWalletCreateResponse.builder()
                ...
                .checkoutUrl("https://checkout.example/guest/example")
                .credits("66666")
        ...
        assertThat(guestWalletCreateResponse.checkoutUrl())
            .isEqualTo("https://checkout.example/guest/example")
        ...
        assertThat(guestWalletCreateResponse.instructions()).isEqualTo("instructions")
