...
internal class ListRetrieveMembersParamsTest {
    ...
    @Test
    fun pathParams() {
        val params = ListRetrieveMembersParams.builder().id("id").build()
    ...
    @Test
    fun queryParams() {
        val params = ListRetrieveMembersParams.builder().id("id").cursor("cursor").build()
