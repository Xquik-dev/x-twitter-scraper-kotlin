...
class CommunityRetrieveMembersResponse
...
private constructor(
    ...
    /** A builder for [CommunityRetrieveMembersResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(communityRetrieveMembersResponse: CommunityRetrieveMembersResponse) =
            apply {
                hasNextPage = communityRetrieveMembersResponse.hasNextPage
                nextCursor = communityRetrieveMembersResponse.nextCursor
                users = communityRetrieveMembersResponse.users.map { it.toMutableList() }
                additionalProperties =
                    communityRetrieveMembersResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CommunityRetrieveMembersResponse].
         *
         ...
         */
        fun build(): CommunityRetrieveMembersResponse =
            CommunityRetrieveMembersResponse(
    ...
    fun validate(): CommunityRetrieveMembersResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CommunityRetrieveMembersResponse &&
    ...
    override fun toString() =
        "CommunityRetrieveMembersResponse{hasNextPage=$hasNextPage, nextCursor=$nextCursor, users=$users, additionalProperties=$additionalProperties}"
}
