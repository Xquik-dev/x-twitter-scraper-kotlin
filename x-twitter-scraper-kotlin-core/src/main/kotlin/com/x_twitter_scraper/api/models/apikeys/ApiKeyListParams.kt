...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): ApiKeyListParams =
            ApiKeyListParams(additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "ApiKeyListParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
